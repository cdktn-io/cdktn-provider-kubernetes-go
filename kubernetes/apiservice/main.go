...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "groupPriorityMinimum", GoGetter: "GroupPriorityMinimum"},
			_jsii_.MemberProperty{JsiiProperty: "groupPriorityMinimumInput", GoGetter: "GroupPriorityMinimumInput"},
			_jsii_.MemberProperty{JsiiProperty: "insecureSkipTlsVerify", GoGetter: "InsecureSkipTlsVerify"},
			_jsii_.MemberProperty{JsiiProperty: "insecureSkipTlsVerifyInput", GoGetter: "InsecureSkipTlsVerifyInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInsecureSkipTlsVerify", GoMethod: "ResetInsecureSkipTlsVerify"},
