...
func (a *jsiiProxy_ApiServiceSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiServiceSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
