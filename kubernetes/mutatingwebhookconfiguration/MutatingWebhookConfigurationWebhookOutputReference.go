...
func (j *jsiiProxy_MutatingWebhookConfigurationWebhookOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMutatingWebhookConfigurationWebhookOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MutatingWebhookConfigurationWebhookOutputReference {
	_init_.Initialize()
...
func NewMutatingWebhookConfigurationWebhookOutputReference_Override(m MutatingWebhookConfigurationWebhookOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MutatingWebhookConfigurationWebhookOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MutatingWebhookConfigurationWebhookOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MutatingWebhookConfigurationWebhookOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MutatingWebhookConfigurationWebhookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MutatingWebhookConfigurationWebhookOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
