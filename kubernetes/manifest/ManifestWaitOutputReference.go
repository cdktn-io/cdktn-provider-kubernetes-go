...
func (m *jsiiProxy_ManifestWaitOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManifestWaitOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
