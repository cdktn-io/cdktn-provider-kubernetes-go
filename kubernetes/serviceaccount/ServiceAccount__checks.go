...
func (s *jsiiProxy_ServiceAccount) validatePutImagePullSecretParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ServiceAccountImagePullSecret; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_ServiceAccount) validatePutSecretParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ServiceAccountSecret; received %#v (a %T)", value, value)
		}
	}
