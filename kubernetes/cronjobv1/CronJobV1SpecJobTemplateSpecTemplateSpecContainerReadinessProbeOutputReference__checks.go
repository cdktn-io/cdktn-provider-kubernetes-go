...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecContainerReadinessProbeOutputReference) validatePutGrpcParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*CronJobV1SpecJobTemplateSpecTemplateSpecContainerReadinessProbeGrpc:
		value := value.(*[]*CronJobV1SpecJobTemplateSpecTemplateSpecContainerReadinessProbeGrpc)
	...
	case []*CronJobV1SpecJobTemplateSpecTemplateSpecContainerReadinessProbeGrpc:
		value_ := value.([]*CronJobV1SpecJobTemplateSpecTemplateSpecContainerReadinessProbeGrpc)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CronJobV1SpecJobTemplateSpecTemplateSpecContainerReadinessProbeGrpc; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecContainerReadinessProbeOutputReference) validatePutTcpSocketParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CronJobV1SpecJobTemplateSpecTemplateSpecContainerReadinessProbeTcpSocket; received %#v (a %T)", value, value)
		}
	}
