...
func (c *jsiiProxy_CronJobV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CronJobV1SpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
