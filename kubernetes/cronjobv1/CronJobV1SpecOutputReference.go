...
func (j *jsiiProxy_CronJobV1SpecOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCronJobV1SpecOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CronJobV1SpecOutputReference {
	_init_.Initialize()
...
func NewCronJobV1SpecOutputReference_Override(c CronJobV1SpecOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CronJobV1SpecOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CronJobV1SpecOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CronJobV1SpecOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CronJobV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CronJobV1SpecOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
