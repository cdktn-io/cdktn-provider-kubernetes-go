...
type CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	Grpc() CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeGrpcList
	GrpcInput() interface{}
...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference) Grpc() CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeGrpcList {
	var returns CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeGrpcList
	_jsii_.Get(
		j,
		"grpc",
		&returns,
...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference) GrpcInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"grpcInput",
...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference {
	_init_.Initialize()
...
func NewCronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference_Override(c CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference) PutGrpc(value interface{}) {
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference) ResetGrpc() {
	_jsii_.InvokeVoid(
		c,
		"resetGrpc",
		nil, // no parameters
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecInitContainerReadinessProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
