...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecRunAsGroupRangeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodSecurityPolicyV1Beta1SpecRunAsGroupRangeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PodSecurityPolicyV1Beta1SpecRunAsGroupRangeList {
	_init_.Initialize()
...
func NewPodSecurityPolicyV1Beta1SpecRunAsGroupRangeList_Override(p PodSecurityPolicyV1Beta1SpecRunAsGroupRangeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecRunAsGroupRangeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecRunAsGroupRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecRunAsGroupRangeList) Resolve(context cdktn.IResolveContext) interface{} {
