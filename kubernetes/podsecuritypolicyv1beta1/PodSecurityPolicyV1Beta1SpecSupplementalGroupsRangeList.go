...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSupplementalGroupsRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSupplementalGroupsRangeList) Resolve(context cdktf.IResolveContext) interface{} {
