...
func (h *jsiiProxy_HorizontalPodAutoscalerV2SpecBehaviorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerV2SpecBehaviorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
