...
func (d *jsiiProxy_DeploymentSpecTemplateSpecSecurityContextWindowsOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecSecurityContextWindowsOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
