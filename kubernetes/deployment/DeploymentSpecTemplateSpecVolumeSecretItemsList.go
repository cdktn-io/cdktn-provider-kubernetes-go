...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeSecretItemsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDeploymentSpecTemplateSpecVolumeSecretItemsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DeploymentSpecTemplateSpecVolumeSecretItemsList {
	_init_.Initialize()
...
func NewDeploymentSpecTemplateSpecVolumeSecretItemsList_Override(d DeploymentSpecTemplateSpecVolumeSecretItemsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeSecretItemsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeSecretItemsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeSecretItemsList) Resolve(context cdktf.IResolveContext) interface{} {
