...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesConfigMapList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDeploymentSpecTemplateSpecVolumeProjectedSourcesConfigMapList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DeploymentSpecTemplateSpecVolumeProjectedSourcesConfigMapList {
	_init_.Initialize()
...
func NewDeploymentSpecTemplateSpecVolumeProjectedSourcesConfigMapList_Override(d DeploymentSpecTemplateSpecVolumeProjectedSourcesConfigMapList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesConfigMapList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesConfigMapList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesConfigMapList) Resolve(context cdktn.IResolveContext) interface{} {
