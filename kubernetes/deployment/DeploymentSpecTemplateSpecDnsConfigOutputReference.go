...
func (d *jsiiProxy_DeploymentSpecTemplateSpecDnsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecDnsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
