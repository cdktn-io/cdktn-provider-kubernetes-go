...
func (d *jsiiProxy_DeploymentSpecTemplateSpecContainerReadinessProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecContainerReadinessProbeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
