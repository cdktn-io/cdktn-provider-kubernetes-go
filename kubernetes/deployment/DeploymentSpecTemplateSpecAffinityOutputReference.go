...
func (d *jsiiProxy_DeploymentSpecTemplateSpecAffinityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecAffinityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
