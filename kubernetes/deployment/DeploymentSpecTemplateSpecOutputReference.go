...
func (j *jsiiProxy_DeploymentSpecTemplateSpecOutputReference) RuntimeClassName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"runtimeClassName",
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecOutputReference) RuntimeClassNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecOutputReference) SchedulerName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schedulerName",
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecOutputReference) SchedulerNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schedulerNameInput",
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecOutputReference)SetRuntimeClassName(val *string) {
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecOutputReference)SetSchedulerName(val *string) {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecOutputReference) ResetRuntimeClassName() {
	_jsii_.InvokeVoid(
		d,
		"resetRuntimeClassName",
		nil, // no parameters
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecOutputReference) ResetSchedulerName() {
	_jsii_.InvokeVoid(
		d,
		"resetSchedulerName",
		nil, // no parameters
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
