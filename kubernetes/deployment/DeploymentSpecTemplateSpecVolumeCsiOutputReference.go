...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeCsiOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeCsiOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
