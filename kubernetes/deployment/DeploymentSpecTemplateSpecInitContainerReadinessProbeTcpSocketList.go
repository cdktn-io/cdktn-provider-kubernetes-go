...
func (j *jsiiProxy_DeploymentSpecTemplateSpecInitContainerReadinessProbeTcpSocketList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDeploymentSpecTemplateSpecInitContainerReadinessProbeTcpSocketList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DeploymentSpecTemplateSpecInitContainerReadinessProbeTcpSocketList {
	_init_.Initialize()
...
func NewDeploymentSpecTemplateSpecInitContainerReadinessProbeTcpSocketList_Override(d DeploymentSpecTemplateSpecInitContainerReadinessProbeTcpSocketList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecInitContainerReadinessProbeTcpSocketList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecInitContainerReadinessProbeTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecInitContainerReadinessProbeTcpSocketList) Resolve(context cdktn.IResolveContext) interface{} {
