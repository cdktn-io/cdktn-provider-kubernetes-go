...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) ConfigMapInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"configMapInput",
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) SecretInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"secretInput",
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference {
	_init_.Initialize()
...
func NewDeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference_Override(d DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) PutConfigMap(value interface{}) {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) PutSecret(value interface{}) {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeProjectedSourcesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
