...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTemplateAnnotations", GoMethod: "ResetTemplateAnnotations"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeAttributes", GoMethod: "SynthesizeAttributes"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeHclAttributes", GoMethod: "SynthesizeHclAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "templateAnnotations", GoGetter: "TemplateAnnotations"},
			_jsii_.MemberProperty{JsiiProperty: "templateAnnotationsInput", GoGetter: "TemplateAnnotationsInput"},
