...
func (j *jsiiProxy_ServiceV1StatusList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceV1StatusList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceV1StatusList {
	_init_.Initialize()
...
func NewServiceV1StatusList_Override(s ServiceV1StatusList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceV1StatusList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceV1StatusList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceV1StatusList) Resolve(context cdktn.IResolveContext) interface{} {
