...
func (j *jsiiProxy_NodeTaintTaintList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NodeTaintTaintList) InternalValue() interface{} {
...
func (j *jsiiProxy_NodeTaintTaintList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_NodeTaintTaintList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewNodeTaintTaintList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NodeTaintTaintList {
	...
	j := jsiiProxy_NodeTaintTaintList{}
...
func (j *jsiiProxy_NodeTaintTaintList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_NodeTaintTaintList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_NodeTaintTaintList)SetWrapsSet(val *bool) {
...
func (n *jsiiProxy_NodeTaintTaintList) ComputeFqn() *string {
	var returns *string
...
func (n *jsiiProxy_NodeTaintTaintList) Get(index *float64) NodeTaintTaintOutputReference {
...
func (n *jsiiProxy_NodeTaintTaintList) ToString() *string {
	var returns *string
