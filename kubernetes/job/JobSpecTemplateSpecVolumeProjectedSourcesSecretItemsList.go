...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeProjectedSourcesSecretItemsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobSpecTemplateSpecVolumeProjectedSourcesSecretItemsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobSpecTemplateSpecVolumeProjectedSourcesSecretItemsList {
	_init_.Initialize()
...
func NewJobSpecTemplateSpecVolumeProjectedSourcesSecretItemsList_Override(j JobSpecTemplateSpecVolumeProjectedSourcesSecretItemsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeProjectedSourcesSecretItemsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeProjectedSourcesSecretItemsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeProjectedSourcesSecretItemsList) Resolve(context cdktn.IResolveContext) interface{} {
