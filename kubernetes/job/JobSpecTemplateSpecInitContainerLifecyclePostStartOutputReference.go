...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) JobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference {
	_init_.Initialize()
...
func NewJobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference_Override(j JobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePostStartOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
