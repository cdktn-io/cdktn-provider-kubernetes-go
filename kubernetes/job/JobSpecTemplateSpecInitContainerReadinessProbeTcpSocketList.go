...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerReadinessProbeTcpSocketList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobSpecTemplateSpecInitContainerReadinessProbeTcpSocketList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobSpecTemplateSpecInitContainerReadinessProbeTcpSocketList {
	_init_.Initialize()
...
func NewJobSpecTemplateSpecInitContainerReadinessProbeTcpSocketList_Override(j JobSpecTemplateSpecInitContainerReadinessProbeTcpSocketList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerReadinessProbeTcpSocketList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerReadinessProbeTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerReadinessProbeTcpSocketList) Resolve(context cdktn.IResolveContext) interface{} {
