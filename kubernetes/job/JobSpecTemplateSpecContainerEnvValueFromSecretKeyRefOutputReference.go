...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) Optional() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"optional",
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) OptionalInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"optionalInput",
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference {
	_init_.Initialize()
...
func NewJobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference_Override(j JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference)SetOptional(val interface{}) {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
