...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerEnvValueFromSecretKeyRefOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
