...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference) Optional() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"optional",
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference) OptionalInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"optionalInput",
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference {
	_init_.Initialize()
...
func NewJobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference_Override(j JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference)SetOptional(val interface{}) {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerEnvFromSecretRefOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
