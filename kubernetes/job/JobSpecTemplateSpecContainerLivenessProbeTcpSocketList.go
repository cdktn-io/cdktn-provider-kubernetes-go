...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLivenessProbeTcpSocketList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobSpecTemplateSpecContainerLivenessProbeTcpSocketList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobSpecTemplateSpecContainerLivenessProbeTcpSocketList {
	_init_.Initialize()
...
func NewJobSpecTemplateSpecContainerLivenessProbeTcpSocketList_Override(j JobSpecTemplateSpecContainerLivenessProbeTcpSocketList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLivenessProbeTcpSocketList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLivenessProbeTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLivenessProbeTcpSocketList) Resolve(context cdktn.IResolveContext) interface{} {
