...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList {
	_init_.Initialize()
...
func NewJobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList_Override(j JobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList) Resolve(context cdktn.IResolveContext) interface{} {
