...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePreStopTcpSocketList) Resolve(context cdktf.IResolveContext) interface{} {
