...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePostStartOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobSpecTemplateSpecContainerLifecyclePostStartOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) JobSpecTemplateSpecContainerLifecyclePostStartOutputReference {
	_init_.Initialize()
...
func NewJobSpecTemplateSpecContainerLifecyclePostStartOutputReference_Override(j JobSpecTemplateSpecContainerLifecyclePostStartOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePostStartOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePostStartOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePostStartOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePostStartOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePostStartOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
