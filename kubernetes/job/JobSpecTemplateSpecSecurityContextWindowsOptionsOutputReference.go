...
func (j *jsiiProxy_JobSpecTemplateSpecSecurityContextWindowsOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecSecurityContextWindowsOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
