...
func (j *jsiiProxy_JobSpecTemplateSpecAffinityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecAffinityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
