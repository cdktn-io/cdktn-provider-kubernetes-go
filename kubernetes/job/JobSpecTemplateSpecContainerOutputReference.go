...
func (j *jsiiProxy_JobSpecTemplateSpecContainerOutputReference) RestartPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicy",
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerOutputReference) RestartPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicyInput",
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerOutputReference)SetRestartPolicy(val *string) {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerOutputReference) ResetRestartPolicy() {
	_jsii_.InvokeVoid(
		j,
		"resetRestartPolicy",
		nil, // no parameters
