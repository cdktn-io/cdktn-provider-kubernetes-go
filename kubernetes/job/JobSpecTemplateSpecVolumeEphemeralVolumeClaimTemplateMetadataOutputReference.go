...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeEphemeralVolumeClaimTemplateMetadataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeEphemeralVolumeClaimTemplateMetadataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
