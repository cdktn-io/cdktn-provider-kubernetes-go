...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) JobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference {
	_init_.Initialize()
...
func NewJobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference_Override(j JobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLifecyclePreStopOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
