...
func (s *jsiiProxy_StorageClass) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (s *jsiiProxy_StorageClass) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (s *jsiiProxy_StorageClass) validateMoveToParameters(moveTarget *string, index interface{}) error {
	if moveTarget == nil {
		return fmt.Errorf("parameter moveTarget is required, but nil was provided")
	}
...
func (s *jsiiProxy_StorageClass) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func validateStorageClass_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
