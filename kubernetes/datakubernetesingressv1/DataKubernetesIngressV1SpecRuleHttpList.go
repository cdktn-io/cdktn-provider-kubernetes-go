...
func (j *jsiiProxy_DataKubernetesIngressV1SpecRuleHttpList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesIngressV1SpecRuleHttpList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesIngressV1SpecRuleHttpList {
	_init_.Initialize()
...
func NewDataKubernetesIngressV1SpecRuleHttpList_Override(d DataKubernetesIngressV1SpecRuleHttpList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesIngressV1SpecRuleHttpList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesIngressV1SpecRuleHttpList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesIngressV1SpecRuleHttpList) Resolve(context cdktn.IResolveContext) interface{} {
