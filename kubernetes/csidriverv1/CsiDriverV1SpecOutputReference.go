...
func (c *jsiiProxy_CsiDriverV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CsiDriverV1SpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
