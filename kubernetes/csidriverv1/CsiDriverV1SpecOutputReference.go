...
func (j *jsiiProxy_CsiDriverV1SpecOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCsiDriverV1SpecOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CsiDriverV1SpecOutputReference {
	_init_.Initialize()
...
func NewCsiDriverV1SpecOutputReference_Override(c CsiDriverV1SpecOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CsiDriverV1SpecOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CsiDriverV1SpecOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CsiDriverV1SpecOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CsiDriverV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CsiDriverV1SpecOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
