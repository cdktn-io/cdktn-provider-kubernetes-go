...
func (e *jsiiProxy_EndpointSliceV1MetadataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EndpointSliceV1MetadataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
