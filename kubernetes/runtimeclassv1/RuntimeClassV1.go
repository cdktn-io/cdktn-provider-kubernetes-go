...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/runtime_class_v1 kubernetes_runtime_class_v1}.
...
func (j *jsiiProxy_RuntimeClassV1) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RuntimeClassV1) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RuntimeClassV1) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RuntimeClassV1) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RuntimeClassV1) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/runtime_class_v1 kubernetes_runtime_class_v1} Resource.
...
func (j *jsiiProxy_RuntimeClassV1)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RuntimeClassV1)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RuntimeClassV1)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a RuntimeClassV1 resource upon running "cdktn plan <stack-name>".
func RuntimeClassV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RuntimeClassV1) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RuntimeClassV1) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RuntimeClassV1) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RuntimeClassV1) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RuntimeClassV1) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RuntimeClassV1) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
