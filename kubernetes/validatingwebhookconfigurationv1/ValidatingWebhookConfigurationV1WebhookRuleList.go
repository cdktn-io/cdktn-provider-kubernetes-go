...
func (v *jsiiProxy_ValidatingWebhookConfigurationV1WebhookRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_ValidatingWebhookConfigurationV1WebhookRuleList) Resolve(context cdktf.IResolveContext) interface{} {
