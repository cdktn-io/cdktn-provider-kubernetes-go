...
func (v *jsiiProxy_ValidatingWebhookConfigurationV1WebhookClientConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_ValidatingWebhookConfigurationV1WebhookClientConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
