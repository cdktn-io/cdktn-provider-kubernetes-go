...
func (j *jsiiProxy_EndpointsV1SubsetPortList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEndpointsV1SubsetPortList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EndpointsV1SubsetPortList {
	_init_.Initialize()
...
func NewEndpointsV1SubsetPortList_Override(e EndpointsV1SubsetPortList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EndpointsV1SubsetPortList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EndpointsV1SubsetPortList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EndpointsV1SubsetPortList) Resolve(context cdktn.IResolveContext) interface{} {
