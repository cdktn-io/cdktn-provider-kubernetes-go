...
func (e *jsiiProxy_EndpointsV1) validatePutSubsetParameters(value interface{}) error {
	...
	case []*EndpointsV1Subset:
		value_ := value.([]*EndpointsV1Subset)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EndpointsV1Subset; received %#v (a %T)", value, value)
		}
	}
