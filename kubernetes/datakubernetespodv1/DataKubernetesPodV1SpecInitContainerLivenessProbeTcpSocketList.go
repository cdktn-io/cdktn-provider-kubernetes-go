...
func (j *jsiiProxy_DataKubernetesPodV1SpecInitContainerLivenessProbeTcpSocketList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataKubernetesPodV1SpecInitContainerLivenessProbeTcpSocketList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodV1SpecInitContainerLivenessProbeTcpSocketList {
	_init_.Initialize()
...
func NewDataKubernetesPodV1SpecInitContainerLivenessProbeTcpSocketList_Override(d DataKubernetesPodV1SpecInitContainerLivenessProbeTcpSocketList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodV1SpecInitContainerLivenessProbeTcpSocketList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecInitContainerLivenessProbeTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecInitContainerLivenessProbeTcpSocketList) Resolve(context cdktf.IResolveContext) interface{} {
