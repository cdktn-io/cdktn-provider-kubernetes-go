...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerLifecyclePostStartHttpGetHttpHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerLifecyclePostStartHttpGetHttpHeaderList) Resolve(context cdktf.IResolveContext) interface{} {
