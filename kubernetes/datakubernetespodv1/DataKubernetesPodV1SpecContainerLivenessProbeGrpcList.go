...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeGrpcList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeGrpcList) Resolve(context cdktf.IResolveContext) interface{} {
