...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerReadinessProbeGrpcList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerReadinessProbeGrpcList) Resolve(context cdktf.IResolveContext) interface{} {
