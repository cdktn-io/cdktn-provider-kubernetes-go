...
func (j *jsiiProxy_DataKubernetesPodV1SpecContainerReadinessProbeGrpcList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodV1SpecContainerReadinessProbeGrpcList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodV1SpecContainerReadinessProbeGrpcList {
	_init_.Initialize()
...
func NewDataKubernetesPodV1SpecContainerReadinessProbeGrpcList_Override(d DataKubernetesPodV1SpecContainerReadinessProbeGrpcList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodV1SpecContainerReadinessProbeGrpcList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerReadinessProbeGrpcList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerReadinessProbeGrpcList) Resolve(context cdktn.IResolveContext) interface{} {
