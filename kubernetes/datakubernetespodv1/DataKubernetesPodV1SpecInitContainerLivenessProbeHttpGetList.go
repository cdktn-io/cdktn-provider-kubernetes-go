...
func (j *jsiiProxy_DataKubernetesPodV1SpecInitContainerLivenessProbeHttpGetList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataKubernetesPodV1SpecInitContainerLivenessProbeHttpGetList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodV1SpecInitContainerLivenessProbeHttpGetList {
	_init_.Initialize()
...
func NewDataKubernetesPodV1SpecInitContainerLivenessProbeHttpGetList_Override(d DataKubernetesPodV1SpecInitContainerLivenessProbeHttpGetList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodV1SpecInitContainerLivenessProbeHttpGetList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecInitContainerLivenessProbeHttpGetList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecInitContainerLivenessProbeHttpGetList) Resolve(context cdktf.IResolveContext) interface{} {
