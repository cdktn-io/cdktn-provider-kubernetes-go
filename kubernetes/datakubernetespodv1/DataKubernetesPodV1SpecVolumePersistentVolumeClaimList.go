...
func (d *jsiiProxy_DataKubernetesPodV1SpecVolumePersistentVolumeClaimList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecVolumePersistentVolumeClaimList) Resolve(context cdktf.IResolveContext) interface{} {
