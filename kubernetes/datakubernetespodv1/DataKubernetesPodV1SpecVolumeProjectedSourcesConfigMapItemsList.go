...
func (d *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList) Resolve(context cdktf.IResolveContext) interface{} {
