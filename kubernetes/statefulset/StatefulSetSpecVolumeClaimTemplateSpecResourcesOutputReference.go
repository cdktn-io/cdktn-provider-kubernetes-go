...
func (s *jsiiProxy_StatefulSetSpecVolumeClaimTemplateSpecResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulSetSpecVolumeClaimTemplateSpecResourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
