...
func (j *jsiiProxy_StatefulSetSpecTemplateSpecVolumeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStatefulSetSpecTemplateSpecVolumeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StatefulSetSpecTemplateSpecVolumeOutputReference {
	_init_.Initialize()
...
func NewStatefulSetSpecTemplateSpecVolumeOutputReference_Override(s StatefulSetSpecTemplateSpecVolumeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StatefulSetSpecTemplateSpecVolumeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecVolumeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecVolumeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecVolumeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecVolumeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
