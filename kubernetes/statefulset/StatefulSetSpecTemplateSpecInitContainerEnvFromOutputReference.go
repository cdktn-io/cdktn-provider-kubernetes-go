...
func (j *jsiiProxy_StatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference {
	_init_.Initialize()
...
func NewStatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference_Override(s StatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecInitContainerEnvFromOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
