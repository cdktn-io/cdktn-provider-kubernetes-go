...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecContainerPortOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecContainerPortOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
