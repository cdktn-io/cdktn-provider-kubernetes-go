...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecTopologySpreadConstraintOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecTopologySpreadConstraintOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
