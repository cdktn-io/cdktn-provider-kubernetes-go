...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecContainerLifecyclePostStartTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecContainerLifecyclePostStartTcpSocketList) Resolve(context cdktf.IResolveContext) interface{} {
