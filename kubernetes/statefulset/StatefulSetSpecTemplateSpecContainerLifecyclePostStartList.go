...
func (j *jsiiProxy_StatefulSetSpecTemplateSpecContainerLifecyclePostStartList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStatefulSetSpecTemplateSpecContainerLifecyclePostStartList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StatefulSetSpecTemplateSpecContainerLifecyclePostStartList {
	_init_.Initialize()
...
func NewStatefulSetSpecTemplateSpecContainerLifecyclePostStartList_Override(s StatefulSetSpecTemplateSpecContainerLifecyclePostStartList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StatefulSetSpecTemplateSpecContainerLifecyclePostStartList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecContainerLifecyclePostStartList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecContainerLifecyclePostStartList) Resolve(context cdktn.IResolveContext) interface{} {
