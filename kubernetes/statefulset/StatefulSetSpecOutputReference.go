...
func (j *jsiiProxy_StatefulSetSpecOutputReference) MinReadySeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minReadySeconds",
...
func (j *jsiiProxy_StatefulSetSpecOutputReference) MinReadySecondsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StatefulSetSpecOutputReference)SetMinReadySeconds(val *float64) {
...
func (s *jsiiProxy_StatefulSetSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulSetSpecOutputReference) ResetMinReadySeconds() {
	_jsii_.InvokeVoid(
		s,
		"resetMinReadySeconds",
		nil, // no parameters
...
func (s *jsiiProxy_StatefulSetSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
