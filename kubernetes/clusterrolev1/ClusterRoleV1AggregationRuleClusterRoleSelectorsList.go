...
func (c *jsiiProxy_ClusterRoleV1AggregationRuleClusterRoleSelectorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ClusterRoleV1AggregationRuleClusterRoleSelectorsList) Resolve(context cdktf.IResolveContext) interface{} {
