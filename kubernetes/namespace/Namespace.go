...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/namespace kubernetes_namespace}.
...
func (j *jsiiProxy_Namespace) WaitForDefaultServiceAccount() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Namespace) WaitForDefaultServiceAccountInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/namespace kubernetes_namespace} Resource.
...
func (j *jsiiProxy_Namespace)SetWaitForDefaultServiceAccount(val interface{}) {
...
func (n *jsiiProxy_Namespace) ResetWaitForDefaultServiceAccount() {
	_jsii_.InvokeVoid(
		n,
		"resetWaitForDefaultServiceAccount",
		nil, // no parameters
