...
func (n *jsiiProxy_Namespace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_Namespace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
