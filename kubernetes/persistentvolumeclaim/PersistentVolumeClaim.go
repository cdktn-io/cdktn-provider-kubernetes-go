...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/persistent_volume_claim kubernetes_persistent_volume_claim}.
...
func (j *jsiiProxy_PersistentVolumeClaim) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PersistentVolumeClaim) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PersistentVolumeClaim) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PersistentVolumeClaim) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PersistentVolumeClaim) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/persistent_volume_claim kubernetes_persistent_volume_claim} Resource.
...
func (j *jsiiProxy_PersistentVolumeClaim)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PersistentVolumeClaim)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PersistentVolumeClaim)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a PersistentVolumeClaim resource upon running "cdktn plan <stack-name>".
func PersistentVolumeClaim_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PersistentVolumeClaim) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeClaim) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PersistentVolumeClaim) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeClaim) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PersistentVolumeClaim) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PersistentVolumeClaim) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
