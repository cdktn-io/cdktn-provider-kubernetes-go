...
func (j *jsiiProxy_PersistentVolumeClaimSpecResourcesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPersistentVolumeClaimSpecResourcesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PersistentVolumeClaimSpecResourcesOutputReference {
	_init_.Initialize()
...
func NewPersistentVolumeClaimSpecResourcesOutputReference_Override(p PersistentVolumeClaimSpecResourcesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PersistentVolumeClaimSpecResourcesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PersistentVolumeClaimSpecResourcesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeClaimSpecResourcesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PersistentVolumeClaimSpecResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeClaimSpecResourcesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
