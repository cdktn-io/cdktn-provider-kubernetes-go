...
func (p *jsiiProxy_PersistentVolumeClaimSpecResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeClaimSpecResourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
