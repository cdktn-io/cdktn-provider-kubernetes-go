...
func (r *jsiiProxy_ReplicationControllerSpecTemplateSpecContainerReadinessProbeGrpcList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ReplicationControllerSpecTemplateSpecContainerReadinessProbeGrpcList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewReplicationControllerSpecTemplateSpecContainerReadinessProbeGrpcListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
