...
func (p *jsiiProxy_PodSecurityPolicySpecSeLinuxSeLinuxOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSecurityPolicySpecSeLinuxSeLinuxOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
