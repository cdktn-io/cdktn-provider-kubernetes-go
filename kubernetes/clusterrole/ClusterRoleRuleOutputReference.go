...
func (j *jsiiProxy_ClusterRoleRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewClusterRoleRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ClusterRoleRuleOutputReference {
	_init_.Initialize()
...
func NewClusterRoleRuleOutputReference_Override(c ClusterRoleRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ClusterRoleRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ClusterRoleRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ClusterRoleRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ClusterRoleRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ClusterRoleRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
