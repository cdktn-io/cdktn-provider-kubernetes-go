...
func (s *jsiiProxy_ServiceAccountV1) validatePutImagePullSecretParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ServiceAccountV1ImagePullSecret; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_ServiceAccountV1) validatePutSecretParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ServiceAccountV1Secret; received %#v (a %T)", value, value)
		}
	}
