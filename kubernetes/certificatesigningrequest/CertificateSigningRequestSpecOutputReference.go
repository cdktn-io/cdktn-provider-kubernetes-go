...
func (c *jsiiProxy_CertificateSigningRequestSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CertificateSigningRequestSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
