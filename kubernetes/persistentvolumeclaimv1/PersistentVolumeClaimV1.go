...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/persistent_volume_claim_v1 kubernetes_persistent_volume_claim_v1}.
...
func (j *jsiiProxy_PersistentVolumeClaimV1) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PersistentVolumeClaimV1) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PersistentVolumeClaimV1) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PersistentVolumeClaimV1) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PersistentVolumeClaimV1) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/persistent_volume_claim_v1 kubernetes_persistent_volume_claim_v1} Resource.
...
func (j *jsiiProxy_PersistentVolumeClaimV1)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PersistentVolumeClaimV1)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PersistentVolumeClaimV1)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a PersistentVolumeClaimV1 resource upon running "cdktn plan <stack-name>".
func PersistentVolumeClaimV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PersistentVolumeClaimV1) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeClaimV1) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PersistentVolumeClaimV1) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeClaimV1) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PersistentVolumeClaimV1) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PersistentVolumeClaimV1) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
