...
func (p *jsiiProxy_PersistentVolumeClaimV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeClaimV1SpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
