...
func (e *jsiiProxy_EndpointsSubsetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EndpointsSubsetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
