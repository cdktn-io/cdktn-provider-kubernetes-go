...
func (d *jsiiProxy_DataKubernetesPersistentVolumeV1SpecPersistentVolumeSourceOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (d *jsiiProxy_DataKubernetesPersistentVolumeV1SpecPersistentVolumeSourceOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataKubernetesPersistentVolumeV1SpecPersistentVolumeSourceOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataKubernetesPersistentVolumeV1SpecPersistentVolumeSourceOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
