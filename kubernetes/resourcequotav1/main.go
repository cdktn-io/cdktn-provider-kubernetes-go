...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putScopeSelector", GoMethod: "PutScopeSelector"},
			_jsii_.MemberMethod{JsiiMethod: "resetHard", GoMethod: "ResetHard"},
			_jsii_.MemberMethod{JsiiMethod: "resetScopes", GoMethod: "ResetScopes"},
			_jsii_.MemberMethod{JsiiMethod: "resetScopeSelector", GoMethod: "ResetScopeSelector"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "scopes", GoGetter: "Scopes"},
			_jsii_.MemberProperty{JsiiProperty: "scopeSelector", GoGetter: "ScopeSelector"},
			_jsii_.MemberProperty{JsiiProperty: "scopeSelectorInput", GoGetter: "ScopeSelectorInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "matchExpression", GoGetter: "MatchExpression"},
			_jsii_.MemberProperty{JsiiProperty: "matchExpressionInput", GoGetter: "MatchExpressionInput"},
			_jsii_.MemberMethod{JsiiMethod: "putMatchExpression", GoMethod: "PutMatchExpression"},
			_jsii_.MemberMethod{JsiiMethod: "resetMatchExpression", GoMethod: "ResetMatchExpression"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
