...
func (r *jsiiProxy_ResourceQuotaV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ResourceQuotaV1SpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
