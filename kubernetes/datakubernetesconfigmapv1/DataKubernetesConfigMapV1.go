...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/data-sources/config_map_v1 kubernetes_config_map_v1}.
...
func (j *jsiiProxy_DataKubernetesConfigMapV1) BinaryData() cdktn.StringMap {
...
func (j *jsiiProxy_DataKubernetesConfigMapV1) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataKubernetesConfigMapV1) Data() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"data",
...
func (j *jsiiProxy_DataKubernetesConfigMapV1) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataKubernetesConfigMapV1) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataKubernetesConfigMapV1) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataKubernetesConfigMapV1) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/data-sources/config_map_v1 kubernetes_config_map_v1} Data Source.
...
func (j *jsiiProxy_DataKubernetesConfigMapV1)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataKubernetesConfigMapV1)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataKubernetesConfigMapV1)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataKubernetesConfigMapV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataKubernetesConfigMapV1) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesConfigMapV1) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesConfigMapV1) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataKubernetesConfigMapV1) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
