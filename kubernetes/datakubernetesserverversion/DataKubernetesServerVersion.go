...
import (
	...
	"github.com/cdktn-io/cdktn-provider-kubernetes-go/kubernetes/v17/datakubernetesserverversion/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/data-sources/server_version kubernetes_server_version}.
...
func (j *jsiiProxy_DataKubernetesServerVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataKubernetesServerVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataKubernetesServerVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataKubernetesServerVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataKubernetesServerVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/data-sources/server_version kubernetes_server_version} Data Source.
...
func (j *jsiiProxy_DataKubernetesServerVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataKubernetesServerVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataKubernetesServerVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataKubernetesServerVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataKubernetesServerVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesServerVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesServerVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataKubernetesServerVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
