...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/env kubernetes_env}.
type Env interface {
...
func (j *jsiiProxy_Env) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Env) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Env) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Env) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Env) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/env kubernetes_env} Resource.
...
func (j *jsiiProxy_Env)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Env)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Env)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a Env resource upon running "cdktn plan <stack-name>".
func Env_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Env) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Env) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Env) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Env) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Env) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Env) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
