...
import (
	...
	"github.com/cdktn-io/cdktn-provider-kubernetes-go/kubernetes/v17/provider/internal"
	"github.com/cdktn-io/cdktn-provider-kubernetes-go/kubernetes/v17/providerfunctions"
...
type KubernetesProvider interface {
	...
	Functions() providerfunctions.KubernetesProviderFunctions
	Host() *string
	SetHost(val *string)
	HostInput() *string
...
func (j *jsiiProxy_KubernetesProvider) Functions() providerfunctions.KubernetesProviderFunctions {
	var returns providerfunctions.KubernetesProviderFunctions
	_jsii_.Get(
		j,
		"functions",
		&returns,
