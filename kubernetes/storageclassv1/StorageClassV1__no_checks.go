...
func (s *jsiiProxy_StorageClassV1) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (s *jsiiProxy_StorageClassV1) validateImportFromParameters(id *string) error {
	return nil
}
...
func (s *jsiiProxy_StorageClassV1) validateMoveToParameters(moveTarget *string, index interface{}) error {
	return nil
}

func (s *jsiiProxy_StorageClassV1) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateStorageClassV1_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func (j *jsiiProxy_StorageClassV1) validateSetCountParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_StorageClassV1) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	return nil
}
