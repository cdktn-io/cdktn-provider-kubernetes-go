...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/storage_class_v1 kubernetes_storage_class_v1}.
...
func (j *jsiiProxy_StorageClassV1) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StorageClassV1) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StorageClassV1) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StorageClassV1) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StorageClassV1) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/storage_class_v1 kubernetes_storage_class_v1} Resource.
...
func (j *jsiiProxy_StorageClassV1)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StorageClassV1)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StorageClassV1)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a StorageClassV1 resource upon running "cdktn plan <stack-name>".
func StorageClassV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateStorageClassV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageClassV1) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageClassV1) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageClassV1) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StorageClassV1) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageClassV1) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageClassV1) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageClassV1) MoveToId(id *string) {
...
func (s *jsiiProxy_StorageClassV1) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageClassV1) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
