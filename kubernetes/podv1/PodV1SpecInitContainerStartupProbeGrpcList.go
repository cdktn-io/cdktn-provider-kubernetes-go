...
func (p *jsiiProxy_PodV1SpecInitContainerStartupProbeGrpcList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodV1SpecInitContainerStartupProbeGrpcList) Resolve(context cdktf.IResolveContext) interface{} {
