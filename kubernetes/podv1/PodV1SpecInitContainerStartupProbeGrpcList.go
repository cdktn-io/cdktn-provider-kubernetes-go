...
func (j *jsiiProxy_PodV1SpecInitContainerStartupProbeGrpcList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodV1SpecInitContainerStartupProbeGrpcList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PodV1SpecInitContainerStartupProbeGrpcList {
	_init_.Initialize()
...
func NewPodV1SpecInitContainerStartupProbeGrpcList_Override(p PodV1SpecInitContainerStartupProbeGrpcList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodV1SpecInitContainerStartupProbeGrpcList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodV1SpecInitContainerStartupProbeGrpcList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodV1SpecInitContainerStartupProbeGrpcList) Resolve(context cdktn.IResolveContext) interface{} {
