...
func (p *jsiiProxy_PodV1SpecVolumeEphemeralVolumeClaimTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecVolumeEphemeralVolumeClaimTemplateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
