...
func (p *jsiiProxy_PodV1SpecInitContainerLifecyclePostStartTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodV1SpecInitContainerLifecyclePostStartTcpSocketList) Resolve(context cdktf.IResolveContext) interface{} {
