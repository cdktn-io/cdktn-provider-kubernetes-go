...
func (j *jsiiProxy_PodV1SpecInitContainerLifecyclePostStartTcpSocketList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodV1SpecInitContainerLifecyclePostStartTcpSocketList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PodV1SpecInitContainerLifecyclePostStartTcpSocketList {
	_init_.Initialize()
...
func NewPodV1SpecInitContainerLifecyclePostStartTcpSocketList_Override(p PodV1SpecInitContainerLifecyclePostStartTcpSocketList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodV1SpecInitContainerLifecyclePostStartTcpSocketList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodV1SpecInitContainerLifecyclePostStartTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodV1SpecInitContainerLifecyclePostStartTcpSocketList) Resolve(context cdktn.IResolveContext) interface{} {
