...
func (p *jsiiProxy_PodV1SpecContainerLifecyclePreStopOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecContainerLifecyclePreStopOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
