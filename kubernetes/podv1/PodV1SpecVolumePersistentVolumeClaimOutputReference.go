...
func (p *jsiiProxy_PodV1SpecVolumePersistentVolumeClaimOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecVolumePersistentVolumeClaimOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
