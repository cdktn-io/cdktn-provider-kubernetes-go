...
func (p *jsiiProxy_PodV1SpecInitContainerSecurityContextSeccompProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecInitContainerSecurityContextSeccompProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
