...
func (p *jsiiProxy_PodV1SpecInitContainerLifecyclePostStartOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecInitContainerLifecyclePostStartOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
