...
func (p *jsiiProxy_PodV1SpecContainerEnvFromOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecContainerEnvFromOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
