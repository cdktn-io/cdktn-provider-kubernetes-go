...
func (j *jsiiProxy_PodV1SpecContainerEnvFromOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodV1SpecContainerEnvFromOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PodV1SpecContainerEnvFromOutputReference {
	_init_.Initialize()
...
func NewPodV1SpecContainerEnvFromOutputReference_Override(p PodV1SpecContainerEnvFromOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodV1SpecContainerEnvFromOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodV1SpecContainerEnvFromOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodV1SpecContainerEnvFromOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodV1SpecContainerEnvFromOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodV1SpecContainerEnvFromOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
