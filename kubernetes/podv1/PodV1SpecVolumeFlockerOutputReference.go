...
func (p *jsiiProxy_PodV1SpecVolumeFlockerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecVolumeFlockerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
