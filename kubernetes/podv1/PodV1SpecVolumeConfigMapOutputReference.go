...
func (p *jsiiProxy_PodV1SpecVolumeConfigMapOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecVolumeConfigMapOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
