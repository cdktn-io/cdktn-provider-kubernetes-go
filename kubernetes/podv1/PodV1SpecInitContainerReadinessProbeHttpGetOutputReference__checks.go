...
func (p *jsiiProxy_PodV1SpecInitContainerReadinessProbeHttpGetOutputReference) validatePutHttpHeaderParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*PodV1SpecInitContainerReadinessProbeHttpGetHttpHeader; received %#v (a %T)", value, value)
		}
	}
