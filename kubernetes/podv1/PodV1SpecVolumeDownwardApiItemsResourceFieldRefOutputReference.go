...
func (p *jsiiProxy_PodV1SpecVolumeDownwardApiItemsResourceFieldRefOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecVolumeDownwardApiItemsResourceFieldRefOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
