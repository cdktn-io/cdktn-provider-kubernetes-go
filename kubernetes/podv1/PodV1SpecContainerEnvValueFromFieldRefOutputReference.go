...
func (p *jsiiProxy_PodV1SpecContainerEnvValueFromFieldRefOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecContainerEnvValueFromFieldRefOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
