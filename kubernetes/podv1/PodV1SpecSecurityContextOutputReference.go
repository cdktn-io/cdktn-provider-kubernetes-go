...
func (p *jsiiProxy_PodV1SpecSecurityContextOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecSecurityContextOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
