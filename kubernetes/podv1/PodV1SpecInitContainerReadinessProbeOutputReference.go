...
type PodV1SpecInitContainerReadinessProbeOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	Grpc() PodV1SpecInitContainerReadinessProbeGrpcList
	GrpcInput() interface{}
...
func (j *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference) Grpc() PodV1SpecInitContainerReadinessProbeGrpcList {
	var returns PodV1SpecInitContainerReadinessProbeGrpcList
	_jsii_.Get(
		j,
		"grpc",
		&returns,
...
func (j *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference) GrpcInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"grpcInput",
...
func (j *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodV1SpecInitContainerReadinessProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PodV1SpecInitContainerReadinessProbeOutputReference {
	_init_.Initialize()
...
func NewPodV1SpecInitContainerReadinessProbeOutputReference_Override(p PodV1SpecInitContainerReadinessProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference) PutGrpc(value interface{}) {
...
func (p *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference) ResetGrpc() {
	_jsii_.InvokeVoid(
		p,
		"resetGrpc",
		nil, // no parameters
...
func (p *jsiiProxy_PodV1SpecInitContainerReadinessProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
