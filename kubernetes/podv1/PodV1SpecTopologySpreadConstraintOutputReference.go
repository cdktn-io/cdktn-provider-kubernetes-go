...
func (p *jsiiProxy_PodV1SpecTopologySpreadConstraintOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecTopologySpreadConstraintOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
