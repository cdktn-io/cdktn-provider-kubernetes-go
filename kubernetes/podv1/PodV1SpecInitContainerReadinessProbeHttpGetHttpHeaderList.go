...
func (j *jsiiProxy_PodV1SpecInitContainerReadinessProbeHttpGetHttpHeaderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodV1SpecInitContainerReadinessProbeHttpGetHttpHeaderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PodV1SpecInitContainerReadinessProbeHttpGetHttpHeaderList {
	_init_.Initialize()
...
func NewPodV1SpecInitContainerReadinessProbeHttpGetHttpHeaderList_Override(p PodV1SpecInitContainerReadinessProbeHttpGetHttpHeaderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodV1SpecInitContainerReadinessProbeHttpGetHttpHeaderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodV1SpecInitContainerReadinessProbeHttpGetHttpHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodV1SpecInitContainerReadinessProbeHttpGetHttpHeaderList) Resolve(context cdktn.IResolveContext) interface{} {
