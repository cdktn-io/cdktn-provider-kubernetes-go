...
func (p *jsiiProxy_PodV1SpecInitContainerLifecycleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodV1SpecInitContainerLifecycleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
