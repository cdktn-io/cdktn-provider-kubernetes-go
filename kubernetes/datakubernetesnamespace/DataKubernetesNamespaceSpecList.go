...
func (j *jsiiProxy_DataKubernetesNamespaceSpecList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesNamespaceSpecList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesNamespaceSpecList {
	_init_.Initialize()
...
func NewDataKubernetesNamespaceSpecList_Override(d DataKubernetesNamespaceSpecList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesNamespaceSpecList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesNamespaceSpecList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesNamespaceSpecList) Resolve(context cdktn.IResolveContext) interface{} {
