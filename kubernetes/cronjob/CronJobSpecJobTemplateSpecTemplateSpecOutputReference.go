...
type CronJobSpecJobTemplateSpecTemplateSpecOutputReference interface {
	...
	Os() CronJobSpecJobTemplateSpecTemplateSpecOsOutputReference
	OsInput() *CronJobSpecJobTemplateSpecTemplateSpecOs
	...
	PutOs(value *CronJobSpecJobTemplateSpecTemplateSpecOs)
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecOutputReference) Os() CronJobSpecJobTemplateSpecTemplateSpecOsOutputReference {
	var returns CronJobSpecJobTemplateSpecTemplateSpecOsOutputReference
	_jsii_.Get(
		j,
		"os",
		&returns,
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecOutputReference) OsInput() *CronJobSpecJobTemplateSpecTemplateSpecOs {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecOutputReference) PutOs(value *CronJobSpecJobTemplateSpecTemplateSpecOs) {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecOutputReference) ResetOs() {
	_jsii_.InvokeVoid(
		c,
		"resetOs",
		nil, // no parameters
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
