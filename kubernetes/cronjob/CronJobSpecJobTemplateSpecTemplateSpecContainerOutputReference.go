...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference) RestartPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicy",
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference) RestartPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicyInput",
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference {
	_init_.Initialize()
...
func NewCronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference_Override(c CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference)SetRestartPolicy(val *string) {
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference) ResetRestartPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetRestartPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
