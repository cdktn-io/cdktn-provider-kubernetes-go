...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecPodFailurePolicyRuleOnPodConditionList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCronJobSpecJobTemplateSpecPodFailurePolicyRuleOnPodConditionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CronJobSpecJobTemplateSpecPodFailurePolicyRuleOnPodConditionList {
	_init_.Initialize()
...
func NewCronJobSpecJobTemplateSpecPodFailurePolicyRuleOnPodConditionList_Override(c CronJobSpecJobTemplateSpecPodFailurePolicyRuleOnPodConditionList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecPodFailurePolicyRuleOnPodConditionList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecPodFailurePolicyRuleOnPodConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecPodFailurePolicyRuleOnPodConditionList) Resolve(context cdktf.IResolveContext) interface{} {
