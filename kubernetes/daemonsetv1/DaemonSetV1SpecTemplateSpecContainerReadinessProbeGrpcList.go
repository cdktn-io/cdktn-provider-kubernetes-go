...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerReadinessProbeGrpcList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonSetV1SpecTemplateSpecContainerReadinessProbeGrpcList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DaemonSetV1SpecTemplateSpecContainerReadinessProbeGrpcList {
	_init_.Initialize()
...
func NewDaemonSetV1SpecTemplateSpecContainerReadinessProbeGrpcList_Override(d DaemonSetV1SpecTemplateSpecContainerReadinessProbeGrpcList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerReadinessProbeGrpcList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerReadinessProbeGrpcList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerReadinessProbeGrpcList) Resolve(context cdktn.IResolveContext) interface{} {
