...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerLivenessProbeOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerLivenessProbeOutputReference) validatePutGrpcParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DaemonSetV1SpecTemplateSpecContainerLivenessProbeGrpc; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerLivenessProbeOutputReference) validatePutTcpSocketParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DaemonSetV1SpecTemplateSpecContainerLivenessProbeTcpSocket; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerLivenessProbeOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerLivenessProbeOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDaemonSetV1SpecTemplateSpecContainerLivenessProbeOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
