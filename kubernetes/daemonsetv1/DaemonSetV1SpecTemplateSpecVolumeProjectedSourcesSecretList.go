...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList {
	_init_.Initialize()
...
func NewDaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList_Override(d DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList) Resolve(context cdktn.IResolveContext) interface{} {
