...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesSecretList) Resolve(context cdktf.IResolveContext) interface{} {
