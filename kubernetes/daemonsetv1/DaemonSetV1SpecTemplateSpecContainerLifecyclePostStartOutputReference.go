...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerLifecyclePostStartOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerLifecyclePostStartOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
