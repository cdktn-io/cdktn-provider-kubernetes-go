...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerLifecyclePostStartHttpGetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerLifecyclePostStartHttpGetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
