...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerLivenessProbeTcpSocketList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonSetV1SpecTemplateSpecInitContainerLivenessProbeTcpSocketList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DaemonSetV1SpecTemplateSpecInitContainerLivenessProbeTcpSocketList {
	_init_.Initialize()
...
func NewDaemonSetV1SpecTemplateSpecInitContainerLivenessProbeTcpSocketList_Override(d DaemonSetV1SpecTemplateSpecInitContainerLivenessProbeTcpSocketList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerLivenessProbeTcpSocketList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerLivenessProbeTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerLivenessProbeTcpSocketList) Resolve(context cdktn.IResolveContext) interface{} {
