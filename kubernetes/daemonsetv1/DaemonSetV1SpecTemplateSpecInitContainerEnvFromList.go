...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList) InternalValue() interface{} {
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList) Get(index *float64) DaemonSetV1SpecTemplateSpecInitContainerEnvFromOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DaemonSetV1SpecTemplateSpecInitContainerEnvFromOutputReference
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerEnvFromList) ToString() *string {
	var returns *string
