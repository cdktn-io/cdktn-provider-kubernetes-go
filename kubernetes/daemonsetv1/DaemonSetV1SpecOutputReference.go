...
func (j *jsiiProxy_DaemonSetV1SpecOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonSetV1SpecOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DaemonSetV1SpecOutputReference {
	_init_.Initialize()
...
func NewDaemonSetV1SpecOutputReference_Override(d DaemonSetV1SpecOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonSetV1SpecOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonSetV1SpecOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaemonSetV1SpecOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DaemonSetV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaemonSetV1SpecOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
