...
type DataKubernetesNodesMetadata struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/data-sources/nodes#labels DataKubernetesNodes#labels}
