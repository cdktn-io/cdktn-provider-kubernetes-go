...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/data-sources/storage_class kubernetes_storage_class}.
...
func (j *jsiiProxy_DataKubernetesStorageClass) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataKubernetesStorageClass) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataKubernetesStorageClass) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataKubernetesStorageClass) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataKubernetesStorageClass) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/data-sources/storage_class kubernetes_storage_class} Data Source.
...
func (j *jsiiProxy_DataKubernetesStorageClass)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataKubernetesStorageClass)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataKubernetesStorageClass)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataKubernetesStorageClass_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataKubernetesStorageClass) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesStorageClass) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesStorageClass) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataKubernetesStorageClass) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
