...
func (d *jsiiProxy_DefaultServiceAccount) validatePutImagePullSecretParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DefaultServiceAccountImagePullSecret; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DefaultServiceAccount) validatePutSecretParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DefaultServiceAccountSecret; received %#v (a %T)", value, value)
		}
	}
