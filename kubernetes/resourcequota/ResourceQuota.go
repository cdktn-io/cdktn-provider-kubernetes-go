...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/resource_quota kubernetes_resource_quota}.
...
func (j *jsiiProxy_ResourceQuota) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ResourceQuota) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ResourceQuota) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ResourceQuota) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ResourceQuota) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/resource_quota kubernetes_resource_quota} Resource.
...
func (j *jsiiProxy_ResourceQuota)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ResourceQuota)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ResourceQuota)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a ResourceQuota resource upon running "cdktn plan <stack-name>".
func ResourceQuota_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_ResourceQuota) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceQuota) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_ResourceQuota) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceQuota) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_ResourceQuota) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_ResourceQuota) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
