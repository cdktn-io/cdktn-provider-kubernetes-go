...
func (j *jsiiProxy_ResourceQuotaSpecScopeSelectorMatchExpressionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourceQuotaSpecScopeSelectorMatchExpressionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ResourceQuotaSpecScopeSelectorMatchExpressionList {
	_init_.Initialize()
...
func NewResourceQuotaSpecScopeSelectorMatchExpressionList_Override(r ResourceQuotaSpecScopeSelectorMatchExpressionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourceQuotaSpecScopeSelectorMatchExpressionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorMatchExpressionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorMatchExpressionList) Resolve(context cdktn.IResolveContext) interface{} {
