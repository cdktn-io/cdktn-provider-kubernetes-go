...
type JobV1SpecTemplateSpecInitContainerOutputReference interface {
	...
	TtyInput() interface{}
	VolumeDevice() JobV1SpecTemplateSpecInitContainerVolumeDeviceList
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerOutputReference) RestartPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicy",
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerOutputReference) RestartPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicyInput",
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerOutputReference) VolumeDevice() JobV1SpecTemplateSpecInitContainerVolumeDeviceList {
	var returns JobV1SpecTemplateSpecInitContainerVolumeDeviceList
	_jsii_.Get(
		j,
		"volumeDevice",
		&returns,
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerOutputReference) VolumeDeviceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"volumeDeviceInput",
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerOutputReference)SetRestartPolicy(val *string) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerOutputReference) PutVolumeDevice(value interface{}) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerOutputReference) ResetRestartPolicy() {
	_jsii_.InvokeVoid(
		j,
		"resetRestartPolicy",
		nil, // no parameters
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerOutputReference) ResetVolumeDevice() {
	_jsii_.InvokeVoid(
		j,
		"resetVolumeDevice",
		nil, // no parameters
