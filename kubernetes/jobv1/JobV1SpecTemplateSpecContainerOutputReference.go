...
type JobV1SpecTemplateSpecContainerOutputReference interface {
	...
	TtyInput() interface{}
	VolumeDevice() JobV1SpecTemplateSpecContainerVolumeDeviceList
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference) VolumeDevice() JobV1SpecTemplateSpecContainerVolumeDeviceList {
	var returns JobV1SpecTemplateSpecContainerVolumeDeviceList
	_jsii_.Get(
		j,
		"volumeDevice",
		&returns,
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference) VolumeDeviceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"volumeDeviceInput",
...
func NewJobV1SpecTemplateSpecContainerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) JobV1SpecTemplateSpecContainerOutputReference {
	_init_.Initialize()
...
func NewJobV1SpecTemplateSpecContainerOutputReference_Override(j JobV1SpecTemplateSpecContainerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference) PutVolumeDevice(value interface{}) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference) ResetVolumeDevice() {
	_jsii_.InvokeVoid(
		j,
		"resetVolumeDevice",
		nil, // no parameters
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
