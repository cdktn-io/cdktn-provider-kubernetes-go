...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerLifecyclePreStopOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerLifecyclePreStopOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
