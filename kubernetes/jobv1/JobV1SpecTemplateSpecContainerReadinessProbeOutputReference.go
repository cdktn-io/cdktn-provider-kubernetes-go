...
type JobV1SpecTemplateSpecContainerReadinessProbeOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	Grpc() JobV1SpecTemplateSpecContainerReadinessProbeGrpcList
	GrpcInput() interface{}
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference) Grpc() JobV1SpecTemplateSpecContainerReadinessProbeGrpcList {
	var returns JobV1SpecTemplateSpecContainerReadinessProbeGrpcList
	_jsii_.Get(
		j,
		"grpc",
		&returns,
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference) GrpcInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"grpcInput",
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobV1SpecTemplateSpecContainerReadinessProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) JobV1SpecTemplateSpecContainerReadinessProbeOutputReference {
	_init_.Initialize()
...
func NewJobV1SpecTemplateSpecContainerReadinessProbeOutputReference_Override(j JobV1SpecTemplateSpecContainerReadinessProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference) PutGrpc(value interface{}) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference) ResetGrpc() {
	_jsii_.InvokeVoid(
		j,
		"resetGrpc",
		nil, // no parameters
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerReadinessProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
