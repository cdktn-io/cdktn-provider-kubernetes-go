...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/job_v1 kubernetes_job_v1}.
...
func (j *jsiiProxy_JobV1) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_JobV1) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_JobV1) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_JobV1) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_JobV1) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/job_v1 kubernetes_job_v1} Resource.
...
func (j *jsiiProxy_JobV1)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_JobV1)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_JobV1)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func JobV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (j *jsiiProxy_JobV1) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobV1) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (j *jsiiProxy_JobV1) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobV1) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (j *jsiiProxy_JobV1) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (j *jsiiProxy_JobV1) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
