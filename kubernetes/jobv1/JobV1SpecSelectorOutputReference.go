...
func (j *jsiiProxy_JobV1SpecSelectorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobV1SpecSelectorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
