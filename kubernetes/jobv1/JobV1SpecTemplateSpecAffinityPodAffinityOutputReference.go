...
func (j *jsiiProxy_JobV1SpecTemplateSpecAffinityPodAffinityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecAffinityPodAffinityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
