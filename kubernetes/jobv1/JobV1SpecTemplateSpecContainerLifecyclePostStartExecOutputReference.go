...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerLifecyclePostStartExecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerLifecyclePostStartExecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
