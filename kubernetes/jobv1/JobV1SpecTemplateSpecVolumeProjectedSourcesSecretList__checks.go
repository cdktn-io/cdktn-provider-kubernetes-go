...
func (j *jsiiProxy_JobV1SpecTemplateSpecVolumeProjectedSourcesSecretList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecVolumeProjectedSourcesSecretList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecVolumeProjectedSourcesSecretList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
