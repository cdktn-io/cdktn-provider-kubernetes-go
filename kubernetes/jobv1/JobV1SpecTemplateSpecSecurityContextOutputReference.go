...
type JobV1SpecTemplateSpecSecurityContextOutputReference interface {
	...
	WindowsOptions() JobV1SpecTemplateSpecSecurityContextWindowsOptionsOutputReference
	WindowsOptionsInput() *JobV1SpecTemplateSpecSecurityContextWindowsOptions
	// Experimental.
	ComputeFqn() *string
	// Experimental.
	...
	PutWindowsOptions(value *JobV1SpecTemplateSpecSecurityContextWindowsOptions)
	ResetFsGroup()
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference) FsGroupChangePolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fsGroupChangePolicy",
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference) FsGroupChangePolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference) WindowsOptions() JobV1SpecTemplateSpecSecurityContextWindowsOptionsOutputReference {
	var returns JobV1SpecTemplateSpecSecurityContextWindowsOptionsOutputReference
	_jsii_.Get(
		j,
		"windowsOptions",
		&returns,
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference) WindowsOptionsInput() *JobV1SpecTemplateSpecSecurityContextWindowsOptions {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference)SetFsGroupChangePolicy(val *string) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference) PutWindowsOptions(value *JobV1SpecTemplateSpecSecurityContextWindowsOptions) {
	if err := j.validatePutWindowsOptionsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		j,
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference) ResetFsGroupChangePolicy() {
	_jsii_.InvokeVoid(
		j,
		"resetFsGroupChangePolicy",
		nil, // no parameters
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference) ResetWindowsOptions() {
	_jsii_.InvokeVoid(
		j,
		"resetWindowsOptions",
		nil, // no parameters
...
func (j *jsiiProxy_JobV1SpecTemplateSpecSecurityContextOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
