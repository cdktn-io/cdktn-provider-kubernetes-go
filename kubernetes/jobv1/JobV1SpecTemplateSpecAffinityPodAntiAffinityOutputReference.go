...
func (j *jsiiProxy_JobV1SpecTemplateSpecAffinityPodAntiAffinityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecAffinityPodAntiAffinityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
