...
func (j *jsiiProxy_PersistentVolumeSpecNodeAffinityRequiredNodeSelectorTermList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPersistentVolumeSpecNodeAffinityRequiredNodeSelectorTermList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PersistentVolumeSpecNodeAffinityRequiredNodeSelectorTermList {
	_init_.Initialize()
...
func NewPersistentVolumeSpecNodeAffinityRequiredNodeSelectorTermList_Override(p PersistentVolumeSpecNodeAffinityRequiredNodeSelectorTermList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PersistentVolumeSpecNodeAffinityRequiredNodeSelectorTermList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PersistentVolumeSpecNodeAffinityRequiredNodeSelectorTermList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PersistentVolumeSpecNodeAffinityRequiredNodeSelectorTermList) Resolve(context cdktn.IResolveContext) interface{} {
