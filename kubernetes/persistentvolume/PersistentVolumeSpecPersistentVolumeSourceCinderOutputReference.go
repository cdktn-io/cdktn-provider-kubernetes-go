...
func (p *jsiiProxy_PersistentVolumeSpecPersistentVolumeSourceCinderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeSpecPersistentVolumeSourceCinderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
