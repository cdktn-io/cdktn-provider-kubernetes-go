...
func (p *jsiiProxy_PersistentVolumeSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PersistentVolumeSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
