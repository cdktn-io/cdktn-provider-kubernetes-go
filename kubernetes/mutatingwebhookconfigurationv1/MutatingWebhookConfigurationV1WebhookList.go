...
func (m *jsiiProxy_MutatingWebhookConfigurationV1WebhookList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MutatingWebhookConfigurationV1WebhookList) Resolve(context cdktf.IResolveContext) interface{} {
