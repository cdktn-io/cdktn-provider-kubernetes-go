...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "reinvocationPolicyInput", GoGetter: "ReinvocationPolicyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetReinvocationPolicy", GoMethod: "ResetReinvocationPolicy"},
