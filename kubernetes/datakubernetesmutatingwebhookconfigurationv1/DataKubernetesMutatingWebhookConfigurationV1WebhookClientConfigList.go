...
func (j *jsiiProxy_DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList {
	_init_.Initialize()
...
func NewDataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList_Override(d DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList) Resolve(context cdktn.IResolveContext) interface{} {
