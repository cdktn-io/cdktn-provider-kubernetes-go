...
func (j *jsiiProxy_DataKubernetesMutatingWebhookConfigurationV1WebhookList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesMutatingWebhookConfigurationV1WebhookList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesMutatingWebhookConfigurationV1WebhookList {
	_init_.Initialize()
...
func NewDataKubernetesMutatingWebhookConfigurationV1WebhookList_Override(d DataKubernetesMutatingWebhookConfigurationV1WebhookList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesMutatingWebhookConfigurationV1WebhookList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesMutatingWebhookConfigurationV1WebhookList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesMutatingWebhookConfigurationV1WebhookList) Resolve(context cdktn.IResolveContext) interface{} {
