...
type DataKubernetesPodSpecContainerStartupProbeOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	Grpc() DataKubernetesPodSpecContainerStartupProbeGrpcList
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerStartupProbeOutputReference) Grpc() DataKubernetesPodSpecContainerStartupProbeGrpcList {
	var returns DataKubernetesPodSpecContainerStartupProbeGrpcList
	_jsii_.Get(
		j,
		"grpc",
		&returns,
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerStartupProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecContainerStartupProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataKubernetesPodSpecContainerStartupProbeOutputReference {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecContainerStartupProbeOutputReference_Override(d DataKubernetesPodSpecContainerStartupProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerStartupProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerStartupProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerStartupProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerStartupProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerStartupProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
