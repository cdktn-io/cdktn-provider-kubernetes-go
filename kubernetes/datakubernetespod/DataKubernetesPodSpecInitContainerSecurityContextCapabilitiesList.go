...
func (j *jsiiProxy_DataKubernetesPodSpecInitContainerSecurityContextCapabilitiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecInitContainerSecurityContextCapabilitiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecInitContainerSecurityContextCapabilitiesList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecInitContainerSecurityContextCapabilitiesList_Override(d DataKubernetesPodSpecInitContainerSecurityContextCapabilitiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecInitContainerSecurityContextCapabilitiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecInitContainerSecurityContextCapabilitiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecInitContainerSecurityContextCapabilitiesList) Resolve(context cdktn.IResolveContext) interface{} {
