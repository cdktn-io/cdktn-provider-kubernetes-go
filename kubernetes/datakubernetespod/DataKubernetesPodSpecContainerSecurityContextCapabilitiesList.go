...
func (j *jsiiProxy_DataKubernetesPodSpecContainerSecurityContextCapabilitiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecContainerSecurityContextCapabilitiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecContainerSecurityContextCapabilitiesList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecContainerSecurityContextCapabilitiesList_Override(d DataKubernetesPodSpecContainerSecurityContextCapabilitiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerSecurityContextCapabilitiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerSecurityContextCapabilitiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerSecurityContextCapabilitiesList) Resolve(context cdktn.IResolveContext) interface{} {
