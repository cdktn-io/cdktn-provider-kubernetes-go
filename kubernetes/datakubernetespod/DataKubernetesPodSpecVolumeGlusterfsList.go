...
func (j *jsiiProxy_DataKubernetesPodSpecVolumeGlusterfsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecVolumeGlusterfsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecVolumeGlusterfsList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecVolumeGlusterfsList_Override(d DataKubernetesPodSpecVolumeGlusterfsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecVolumeGlusterfsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecVolumeGlusterfsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecVolumeGlusterfsList) Resolve(context cdktn.IResolveContext) interface{} {
