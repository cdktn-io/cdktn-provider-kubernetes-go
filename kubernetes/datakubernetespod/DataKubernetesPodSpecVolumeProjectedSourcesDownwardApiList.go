...
func (j *jsiiProxy_DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecVolumeProjectedSourcesDownwardApiList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecVolumeProjectedSourcesDownwardApiList_Override(d DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiList) Resolve(context cdktn.IResolveContext) interface{} {
