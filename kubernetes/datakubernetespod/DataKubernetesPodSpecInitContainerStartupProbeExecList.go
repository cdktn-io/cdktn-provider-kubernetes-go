...
func (j *jsiiProxy_DataKubernetesPodSpecInitContainerStartupProbeExecList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecInitContainerStartupProbeExecList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecInitContainerStartupProbeExecList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecInitContainerStartupProbeExecList_Override(d DataKubernetesPodSpecInitContainerStartupProbeExecList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecInitContainerStartupProbeExecList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecInitContainerStartupProbeExecList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecInitContainerStartupProbeExecList) Resolve(context cdktn.IResolveContext) interface{} {
