...
func (j *jsiiProxy_DataKubernetesPodSpecSecurityContextSeLinuxOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecSecurityContextSeLinuxOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecSecurityContextSeLinuxOptionsList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecSecurityContextSeLinuxOptionsList_Override(d DataKubernetesPodSpecSecurityContextSeLinuxOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecSecurityContextSeLinuxOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecSecurityContextSeLinuxOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecSecurityContextSeLinuxOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
