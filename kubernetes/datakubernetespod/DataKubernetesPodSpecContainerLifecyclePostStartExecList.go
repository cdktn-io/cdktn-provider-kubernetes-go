...
func (j *jsiiProxy_DataKubernetesPodSpecContainerLifecyclePostStartExecList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecContainerLifecyclePostStartExecList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecContainerLifecyclePostStartExecList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecContainerLifecyclePostStartExecList_Override(d DataKubernetesPodSpecContainerLifecyclePostStartExecList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerLifecyclePostStartExecList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerLifecyclePostStartExecList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerLifecyclePostStartExecList) Resolve(context cdktn.IResolveContext) interface{} {
