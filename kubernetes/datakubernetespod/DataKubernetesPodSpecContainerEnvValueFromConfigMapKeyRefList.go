...
func (j *jsiiProxy_DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRefList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRefList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRefList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRefList_Override(d DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRefList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRefList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRefList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRefList) Resolve(context cdktn.IResolveContext) interface{} {
