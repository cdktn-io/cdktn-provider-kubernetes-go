...
func (j *jsiiProxy_DataKubernetesPodSpecVolumeFcList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecVolumeFcList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecVolumeFcList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecVolumeFcList_Override(d DataKubernetesPodSpecVolumeFcList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecVolumeFcList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecVolumeFcList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecVolumeFcList) Resolve(context cdktn.IResolveContext) interface{} {
