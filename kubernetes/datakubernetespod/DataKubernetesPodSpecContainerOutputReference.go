...
func (d *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
