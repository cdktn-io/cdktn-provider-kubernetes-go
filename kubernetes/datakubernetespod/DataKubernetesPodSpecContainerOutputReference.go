...
func (j *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) RestartPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicy",
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) Stdin() cdktn.IResolvable {
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) StdinOnce() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"stdinOnce",
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) Tty() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"tty",
...
func NewDataKubernetesPodSpecContainerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataKubernetesPodSpecContainerOutputReference {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecContainerOutputReference_Override(d DataKubernetesPodSpecContainerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataKubernetesPodSpecContainerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
