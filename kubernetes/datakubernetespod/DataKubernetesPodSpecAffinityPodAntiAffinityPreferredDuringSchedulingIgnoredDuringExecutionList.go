...
func (d *jsiiProxy_DataKubernetesPodSpecAffinityPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionList) Resolve(context cdktf.IResolveContext) interface{} {
