...
func (d *jsiiProxy_DataKubernetesPodSpecContainerStartupProbeList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_DataKubernetesPodSpecContainerStartupProbeList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewDataKubernetesPodSpecContainerStartupProbeListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
