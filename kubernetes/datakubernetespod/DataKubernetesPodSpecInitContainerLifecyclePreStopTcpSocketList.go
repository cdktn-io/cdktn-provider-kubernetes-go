...
func (j *jsiiProxy_DataKubernetesPodSpecInitContainerLifecyclePreStopTcpSocketList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesPodSpecInitContainerLifecyclePreStopTcpSocketList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecInitContainerLifecyclePreStopTcpSocketList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecInitContainerLifecyclePreStopTcpSocketList_Override(d DataKubernetesPodSpecInitContainerLifecyclePreStopTcpSocketList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecInitContainerLifecyclePreStopTcpSocketList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecInitContainerLifecyclePreStopTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecInitContainerLifecyclePreStopTcpSocketList) Resolve(context cdktn.IResolveContext) interface{} {
