...
func (d *jsiiProxy_DataKubernetesPodSpecAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceList) Resolve(context cdktf.IResolveContext) interface{} {
