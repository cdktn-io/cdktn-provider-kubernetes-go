...
func (j *jsiiProxy_PodDisruptionBudgetV1SpecOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodDisruptionBudgetV1SpecOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PodDisruptionBudgetV1SpecOutputReference {
	_init_.Initialize()
...
func NewPodDisruptionBudgetV1SpecOutputReference_Override(p PodDisruptionBudgetV1SpecOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodDisruptionBudgetV1SpecOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodDisruptionBudgetV1SpecOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodDisruptionBudgetV1SpecOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodDisruptionBudgetV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodDisruptionBudgetV1SpecOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
