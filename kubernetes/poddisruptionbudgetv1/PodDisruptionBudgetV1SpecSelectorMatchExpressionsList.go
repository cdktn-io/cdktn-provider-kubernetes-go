...
func (j *jsiiProxy_PodDisruptionBudgetV1SpecSelectorMatchExpressionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodDisruptionBudgetV1SpecSelectorMatchExpressionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PodDisruptionBudgetV1SpecSelectorMatchExpressionsList {
	_init_.Initialize()
...
func NewPodDisruptionBudgetV1SpecSelectorMatchExpressionsList_Override(p PodDisruptionBudgetV1SpecSelectorMatchExpressionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodDisruptionBudgetV1SpecSelectorMatchExpressionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodDisruptionBudgetV1SpecSelectorMatchExpressionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodDisruptionBudgetV1SpecSelectorMatchExpressionsList) Resolve(context cdktn.IResolveContext) interface{} {
