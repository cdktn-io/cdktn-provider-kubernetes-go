...
func (j *jsiiProxy_DataKubernetesServiceV1SpecSessionAffinityConfigClientIpList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataKubernetesServiceV1SpecSessionAffinityConfigClientIpList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesServiceV1SpecSessionAffinityConfigClientIpList {
	_init_.Initialize()
...
func NewDataKubernetesServiceV1SpecSessionAffinityConfigClientIpList_Override(d DataKubernetesServiceV1SpecSessionAffinityConfigClientIpList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesServiceV1SpecSessionAffinityConfigClientIpList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesServiceV1SpecSessionAffinityConfigClientIpList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesServiceV1SpecSessionAffinityConfigClientIpList) Resolve(context cdktf.IResolveContext) interface{} {
