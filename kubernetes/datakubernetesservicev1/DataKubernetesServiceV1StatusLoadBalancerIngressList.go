...
func (d *jsiiProxy_DataKubernetesServiceV1StatusLoadBalancerIngressList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesServiceV1StatusLoadBalancerIngressList) Resolve(context cdktf.IResolveContext) interface{} {
