...
func (v *jsiiProxy_ValidatingWebhookConfigurationWebhookNamespaceSelectorMatchExpressionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_ValidatingWebhookConfigurationWebhookNamespaceSelectorMatchExpressionsList) Resolve(context cdktf.IResolveContext) interface{} {
