...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecContainerLifecyclePreStopHttpGetHttpHeaderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonsetSpecTemplateSpecContainerLifecyclePreStopHttpGetHttpHeaderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DaemonsetSpecTemplateSpecContainerLifecyclePreStopHttpGetHttpHeaderList {
	_init_.Initialize()
...
func NewDaemonsetSpecTemplateSpecContainerLifecyclePreStopHttpGetHttpHeaderList_Override(d DaemonsetSpecTemplateSpecContainerLifecyclePreStopHttpGetHttpHeaderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecContainerLifecyclePreStopHttpGetHttpHeaderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecContainerLifecyclePreStopHttpGetHttpHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecContainerLifecyclePreStopHttpGetHttpHeaderList) Resolve(context cdktn.IResolveContext) interface{} {
