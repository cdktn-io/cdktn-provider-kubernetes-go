...
func (d *jsiiProxy_DaemonsetSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
