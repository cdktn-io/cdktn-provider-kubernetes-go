...
func (j *jsiiProxy_DaemonsetSpecOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonsetSpecOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DaemonsetSpecOutputReference {
	_init_.Initialize()
...
func NewDaemonsetSpecOutputReference_Override(d DaemonsetSpecOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonsetSpecOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonsetSpecOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DaemonsetSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
