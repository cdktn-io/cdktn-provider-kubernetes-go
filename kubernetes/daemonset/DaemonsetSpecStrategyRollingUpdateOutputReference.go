...
func (d *jsiiProxy_DaemonsetSpecStrategyRollingUpdateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecStrategyRollingUpdateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
