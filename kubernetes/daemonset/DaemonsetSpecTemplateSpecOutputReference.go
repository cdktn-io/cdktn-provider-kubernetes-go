...
type DaemonsetSpecTemplateSpecOutputReference interface {
	...
	Os() DaemonsetSpecTemplateSpecOsOutputReference
	OsInput() *DaemonsetSpecTemplateSpecOs
	...
	PutOs(value *DaemonsetSpecTemplateSpecOs)
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference) Os() DaemonsetSpecTemplateSpecOsOutputReference {
	var returns DaemonsetSpecTemplateSpecOsOutputReference
	_jsii_.Get(
		j,
		"os",
		&returns,
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference) OsInput() *DaemonsetSpecTemplateSpecOs {
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference) SchedulerName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schedulerName",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference) SchedulerNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schedulerNameInput",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference)SetSchedulerName(val *string) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference) PutOs(value *DaemonsetSpecTemplateSpecOs) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference) ResetOs() {
	_jsii_.InvokeVoid(
		d,
		"resetOs",
		nil, // no parameters
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference) ResetSchedulerName() {
	_jsii_.InvokeVoid(
		d,
		"resetSchedulerName",
		nil, // no parameters
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
