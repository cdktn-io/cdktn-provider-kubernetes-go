...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecVolumeProjectedSourcesConfigMapList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonsetSpecTemplateSpecVolumeProjectedSourcesConfigMapList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DaemonsetSpecTemplateSpecVolumeProjectedSourcesConfigMapList {
	_init_.Initialize()
...
func NewDaemonsetSpecTemplateSpecVolumeProjectedSourcesConfigMapList_Override(d DaemonsetSpecTemplateSpecVolumeProjectedSourcesConfigMapList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecVolumeProjectedSourcesConfigMapList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecVolumeProjectedSourcesConfigMapList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecVolumeProjectedSourcesConfigMapList) Resolve(context cdktn.IResolveContext) interface{} {
