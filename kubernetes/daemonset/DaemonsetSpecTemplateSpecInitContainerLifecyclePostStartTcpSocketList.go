...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerLifecyclePostStartTcpSocketList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonsetSpecTemplateSpecInitContainerLifecyclePostStartTcpSocketList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DaemonsetSpecTemplateSpecInitContainerLifecyclePostStartTcpSocketList {
	_init_.Initialize()
...
func NewDaemonsetSpecTemplateSpecInitContainerLifecyclePostStartTcpSocketList_Override(d DaemonsetSpecTemplateSpecInitContainerLifecyclePostStartTcpSocketList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerLifecyclePostStartTcpSocketList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerLifecyclePostStartTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerLifecyclePostStartTcpSocketList) Resolve(context cdktn.IResolveContext) interface{} {
