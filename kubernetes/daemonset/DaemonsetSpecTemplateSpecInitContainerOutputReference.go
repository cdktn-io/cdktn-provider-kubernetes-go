...
type DaemonsetSpecTemplateSpecInitContainerOutputReference interface {
	...
	TtyInput() interface{}
	VolumeDevice() DaemonsetSpecTemplateSpecInitContainerVolumeDeviceList
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerOutputReference) RestartPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicy",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerOutputReference) RestartPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicyInput",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerOutputReference) VolumeDevice() DaemonsetSpecTemplateSpecInitContainerVolumeDeviceList {
	var returns DaemonsetSpecTemplateSpecInitContainerVolumeDeviceList
	_jsii_.Get(
		j,
		"volumeDevice",
		&returns,
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerOutputReference) VolumeDeviceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"volumeDeviceInput",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerOutputReference)SetRestartPolicy(val *string) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerOutputReference) PutVolumeDevice(value interface{}) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerOutputReference) ResetRestartPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetRestartPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerOutputReference) ResetVolumeDevice() {
	_jsii_.InvokeVoid(
		d,
		"resetVolumeDevice",
		nil, // no parameters
