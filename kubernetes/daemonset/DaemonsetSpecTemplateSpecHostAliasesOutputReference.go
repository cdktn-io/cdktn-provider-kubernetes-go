...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecHostAliasesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonsetSpecTemplateSpecHostAliasesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DaemonsetSpecTemplateSpecHostAliasesOutputReference {
	_init_.Initialize()
...
func NewDaemonsetSpecTemplateSpecHostAliasesOutputReference_Override(d DaemonsetSpecTemplateSpecHostAliasesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecHostAliasesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecHostAliasesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecHostAliasesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecHostAliasesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecHostAliasesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
