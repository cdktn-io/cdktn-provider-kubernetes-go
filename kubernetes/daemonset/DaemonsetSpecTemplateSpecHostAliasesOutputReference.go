...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecHostAliasesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecHostAliasesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
