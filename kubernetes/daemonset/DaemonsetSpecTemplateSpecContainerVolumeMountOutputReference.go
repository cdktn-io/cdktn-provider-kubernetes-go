...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference) SubPathExpr() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subPathExpr",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference) SubPathExprInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subPathExprInput",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonsetSpecTemplateSpecContainerVolumeMountOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference {
	_init_.Initialize()
...
func NewDaemonsetSpecTemplateSpecContainerVolumeMountOutputReference_Override(d DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference)SetSubPathExpr(val *string) {
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference) ResetSubPathExpr() {
	_jsii_.InvokeVoid(
		d,
		"resetSubPathExpr",
		nil, // no parameters
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecContainerVolumeMountOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
