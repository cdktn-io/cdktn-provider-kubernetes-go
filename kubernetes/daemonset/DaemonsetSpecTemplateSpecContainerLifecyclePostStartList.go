...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecContainerLifecyclePostStartList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDaemonsetSpecTemplateSpecContainerLifecyclePostStartList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DaemonsetSpecTemplateSpecContainerLifecyclePostStartList {
	_init_.Initialize()
...
func NewDaemonsetSpecTemplateSpecContainerLifecyclePostStartList_Override(d DaemonsetSpecTemplateSpecContainerLifecyclePostStartList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecContainerLifecyclePostStartList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecContainerLifecyclePostStartList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecContainerLifecyclePostStartList) Resolve(context cdktn.IResolveContext) interface{} {
