...
func (j *jsiiProxy_IngressStatusList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IngressStatusList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_IngressStatusList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_IngressStatusList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_IngressStatusList)SetWrapsSet(val *bool) {
...
func (i *jsiiProxy_IngressStatusList) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IngressStatusList) Get(index *float64) IngressStatusOutputReference {
	if err := i.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns IngressStatusOutputReference
...
func (i *jsiiProxy_IngressStatusList) ToString() *string {
	var returns *string
