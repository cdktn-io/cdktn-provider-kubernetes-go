...
func (j *jsiiProxy_PodSpecContainerVolumeMountOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodSpecContainerVolumeMountOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PodSpecContainerVolumeMountOutputReference {
	_init_.Initialize()
...
func NewPodSpecContainerVolumeMountOutputReference_Override(p PodSpecContainerVolumeMountOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSpecContainerVolumeMountOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSpecContainerVolumeMountOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecContainerVolumeMountOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodSpecContainerVolumeMountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecContainerVolumeMountOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
