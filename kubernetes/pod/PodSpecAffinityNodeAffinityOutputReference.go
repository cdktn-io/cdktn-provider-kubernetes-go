...
func (p *jsiiProxy_PodSpecAffinityNodeAffinityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecAffinityNodeAffinityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
