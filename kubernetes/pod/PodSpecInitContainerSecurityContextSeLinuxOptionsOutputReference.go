...
func (p *jsiiProxy_PodSpecInitContainerSecurityContextSeLinuxOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecInitContainerSecurityContextSeLinuxOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
