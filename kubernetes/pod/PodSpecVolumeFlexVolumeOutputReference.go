...
func (p *jsiiProxy_PodSpecVolumeFlexVolumeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecVolumeFlexVolumeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
