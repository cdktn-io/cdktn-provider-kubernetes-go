...
func (j *jsiiProxy_PodSpecVolumeEphemeralVolumeClaimTemplateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodSpecVolumeEphemeralVolumeClaimTemplateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PodSpecVolumeEphemeralVolumeClaimTemplateOutputReference {
	_init_.Initialize()
...
func NewPodSpecVolumeEphemeralVolumeClaimTemplateOutputReference_Override(p PodSpecVolumeEphemeralVolumeClaimTemplateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSpecVolumeEphemeralVolumeClaimTemplateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSpecVolumeEphemeralVolumeClaimTemplateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecVolumeEphemeralVolumeClaimTemplateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodSpecVolumeEphemeralVolumeClaimTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecVolumeEphemeralVolumeClaimTemplateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
