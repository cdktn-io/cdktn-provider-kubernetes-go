...
func (p *jsiiProxy_PodSpecContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecContainerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
