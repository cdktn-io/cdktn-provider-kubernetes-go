...
func (p *jsiiProxy_PodSpecDnsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecDnsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
