...
func (j *jsiiProxy_PodSpecDnsConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodSpecDnsConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PodSpecDnsConfigOutputReference {
	_init_.Initialize()
...
func NewPodSpecDnsConfigOutputReference_Override(p PodSpecDnsConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSpecDnsConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSpecDnsConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecDnsConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodSpecDnsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecDnsConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
