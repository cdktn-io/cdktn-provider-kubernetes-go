...
func (p *jsiiProxy_PodSpecContainerSecurityContextSeccompProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecContainerSecurityContextSeccompProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
