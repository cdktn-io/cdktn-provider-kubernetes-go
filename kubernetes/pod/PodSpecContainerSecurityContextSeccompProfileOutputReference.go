...
func (j *jsiiProxy_PodSpecContainerSecurityContextSeccompProfileOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodSpecContainerSecurityContextSeccompProfileOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PodSpecContainerSecurityContextSeccompProfileOutputReference {
	_init_.Initialize()
...
func NewPodSpecContainerSecurityContextSeccompProfileOutputReference_Override(p PodSpecContainerSecurityContextSeccompProfileOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSpecContainerSecurityContextSeccompProfileOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSpecContainerSecurityContextSeccompProfileOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecContainerSecurityContextSeccompProfileOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodSpecContainerSecurityContextSeccompProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecContainerSecurityContextSeccompProfileOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
