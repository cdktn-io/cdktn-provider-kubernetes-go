...
func (j *jsiiProxy_PodSpecInitContainerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodSpecInitContainerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PodSpecInitContainerList {
	_init_.Initialize()
...
func NewPodSpecInitContainerList_Override(p PodSpecInitContainerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSpecInitContainerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSpecInitContainerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodSpecInitContainerList) Resolve(context cdktn.IResolveContext) interface{} {
