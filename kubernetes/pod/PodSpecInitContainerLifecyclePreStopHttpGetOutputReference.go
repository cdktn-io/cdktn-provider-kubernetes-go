...
func (p *jsiiProxy_PodSpecInitContainerLifecyclePreStopHttpGetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecInitContainerLifecyclePreStopHttpGetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
