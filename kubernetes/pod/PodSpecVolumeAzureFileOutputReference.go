...
func (p *jsiiProxy_PodSpecVolumeAzureFileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecVolumeAzureFileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
