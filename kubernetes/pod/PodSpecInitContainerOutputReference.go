...
func (j *jsiiProxy_PodSpecInitContainerOutputReference) RestartPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicy",
...
func (j *jsiiProxy_PodSpecInitContainerOutputReference) RestartPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicyInput",
...
func (j *jsiiProxy_PodSpecInitContainerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodSpecInitContainerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PodSpecInitContainerOutputReference {
	_init_.Initialize()
...
func NewPodSpecInitContainerOutputReference_Override(p PodSpecInitContainerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSpecInitContainerOutputReference)SetRestartPolicy(val *string) {
...
func (j *jsiiProxy_PodSpecInitContainerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSpecInitContainerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecInitContainerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodSpecInitContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecInitContainerOutputReference) ResetRestartPolicy() {
	_jsii_.InvokeVoid(
		p,
		"resetRestartPolicy",
		nil, // no parameters
...
func (p *jsiiProxy_PodSpecInitContainerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
