...
func (p *jsiiProxy_PodSpecInitContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecInitContainerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
