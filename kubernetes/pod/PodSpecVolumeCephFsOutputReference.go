...
func (p *jsiiProxy_PodSpecVolumeCephFsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecVolumeCephFsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
