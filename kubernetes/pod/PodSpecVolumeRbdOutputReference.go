...
func (p *jsiiProxy_PodSpecVolumeRbdOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecVolumeRbdOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
