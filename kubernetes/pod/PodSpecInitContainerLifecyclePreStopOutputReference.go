...
func (j *jsiiProxy_PodSpecInitContainerLifecyclePreStopOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodSpecInitContainerLifecyclePreStopOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PodSpecInitContainerLifecyclePreStopOutputReference {
	_init_.Initialize()
...
func NewPodSpecInitContainerLifecyclePreStopOutputReference_Override(p PodSpecInitContainerLifecyclePreStopOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSpecInitContainerLifecyclePreStopOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSpecInitContainerLifecyclePreStopOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecInitContainerLifecyclePreStopOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodSpecInitContainerLifecyclePreStopOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecInitContainerLifecyclePreStopOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
