...
func (j *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList) InternalValue() interface{} {
...
func (j *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList)SetWrapsSet(val *bool) {
...
func (p *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList) Get(index *float64) PodSpecContainerStartupProbeTcpSocketOutputReference {
	if err := p.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns PodSpecContainerStartupProbeTcpSocketOutputReference
...
func (p *jsiiProxy_PodSpecContainerStartupProbeTcpSocketList) ToString() *string {
	var returns *string
