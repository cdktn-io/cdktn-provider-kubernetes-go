...
func (p *jsiiProxy_PodSpecInitContainerEnvFromList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PodSpecInitContainerEnvFromList) Resolve(context cdktf.IResolveContext) interface{} {
