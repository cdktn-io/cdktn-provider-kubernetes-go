...
func (p *jsiiProxy_PodSpecAffinityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecAffinityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
