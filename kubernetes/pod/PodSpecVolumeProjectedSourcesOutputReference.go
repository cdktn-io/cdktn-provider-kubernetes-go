...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPodSpecVolumeProjectedSourcesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PodSpecVolumeProjectedSourcesOutputReference {
	_init_.Initialize()
...
func NewPodSpecVolumeProjectedSourcesOutputReference_Override(p PodSpecVolumeProjectedSourcesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
