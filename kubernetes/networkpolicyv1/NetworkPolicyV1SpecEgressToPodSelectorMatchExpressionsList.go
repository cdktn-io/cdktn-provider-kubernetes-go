...
func (j *jsiiProxy_NetworkPolicyV1SpecEgressToPodSelectorMatchExpressionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkPolicyV1SpecEgressToPodSelectorMatchExpressionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkPolicyV1SpecEgressToPodSelectorMatchExpressionsList {
	_init_.Initialize()
...
func NewNetworkPolicyV1SpecEgressToPodSelectorMatchExpressionsList_Override(n NetworkPolicyV1SpecEgressToPodSelectorMatchExpressionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkPolicyV1SpecEgressToPodSelectorMatchExpressionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkPolicyV1SpecEgressToPodSelectorMatchExpressionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkPolicyV1SpecEgressToPodSelectorMatchExpressionsList) Resolve(context cdktn.IResolveContext) interface{} {
