...
func (n *jsiiProxy_NetworkPolicyV1SpecPodSelectorMatchExpressionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkPolicyV1SpecPodSelectorMatchExpressionsList) Resolve(context cdktf.IResolveContext) interface{} {
