...
func (j *jsiiProxy_IngressV1SpecOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIngressV1SpecOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) IngressV1SpecOutputReference {
	_init_.Initialize()
...
func NewIngressV1SpecOutputReference_Override(i IngressV1SpecOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IngressV1SpecOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IngressV1SpecOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IngressV1SpecOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IngressV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IngressV1SpecOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
