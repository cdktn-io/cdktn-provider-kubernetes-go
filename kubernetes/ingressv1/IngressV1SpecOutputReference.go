...
func (i *jsiiProxy_IngressV1SpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IngressV1SpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
