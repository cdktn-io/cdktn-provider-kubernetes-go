...
func (j *jsiiProxy_IngressV1) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IngressV1) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IngressV1) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IngressV1) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IngressV1) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func IngressV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IngressV1) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IngressV1) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IngressV1) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
