...
func (j *jsiiProxy_IngressV1StatusLoadBalancerIngressList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIngressV1StatusLoadBalancerIngressList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IngressV1StatusLoadBalancerIngressList {
	_init_.Initialize()
...
func NewIngressV1StatusLoadBalancerIngressList_Override(i IngressV1StatusLoadBalancerIngressList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IngressV1StatusLoadBalancerIngressList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IngressV1StatusLoadBalancerIngressList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IngressV1StatusLoadBalancerIngressList) Resolve(context cdktn.IResolveContext) interface{} {
