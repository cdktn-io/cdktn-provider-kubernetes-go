...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerLifecycleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerLifecycleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
