...
type StatefulSetV1SpecTemplateSpecSecurityContextOutputReference interface {
	...
	WindowsOptions() StatefulSetV1SpecTemplateSpecSecurityContextWindowsOptionsOutputReference
	WindowsOptionsInput() *StatefulSetV1SpecTemplateSpecSecurityContextWindowsOptions
	// Experimental.
	ComputeFqn() *string
	// Experimental.
	...
	PutWindowsOptions(value *StatefulSetV1SpecTemplateSpecSecurityContextWindowsOptions)
	ResetFsGroup()
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) WindowsOptions() StatefulSetV1SpecTemplateSpecSecurityContextWindowsOptionsOutputReference {
	var returns StatefulSetV1SpecTemplateSpecSecurityContextWindowsOptionsOutputReference
	_jsii_.Get(
		j,
		"windowsOptions",
		&returns,
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) WindowsOptionsInput() *StatefulSetV1SpecTemplateSpecSecurityContextWindowsOptions {
...
func NewStatefulSetV1SpecTemplateSpecSecurityContextOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StatefulSetV1SpecTemplateSpecSecurityContextOutputReference {
	_init_.Initialize()
...
func NewStatefulSetV1SpecTemplateSpecSecurityContextOutputReference_Override(s StatefulSetV1SpecTemplateSpecSecurityContextOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) PutWindowsOptions(value *StatefulSetV1SpecTemplateSpecSecurityContextWindowsOptions) {
	if err := s.validatePutWindowsOptionsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) ResetWindowsOptions() {
	_jsii_.InvokeVoid(
		s,
		"resetWindowsOptions",
		nil, // no parameters
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
