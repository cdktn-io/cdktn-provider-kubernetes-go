...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecSecurityContextOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
