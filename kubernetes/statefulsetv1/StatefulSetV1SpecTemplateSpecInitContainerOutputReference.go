...
type StatefulSetV1SpecTemplateSpecInitContainerOutputReference interface {
	...
	TtyInput() interface{}
	VolumeDevice() StatefulSetV1SpecTemplateSpecInitContainerVolumeDeviceList
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerOutputReference) RestartPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicy",
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerOutputReference) RestartPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restartPolicyInput",
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerOutputReference) VolumeDevice() StatefulSetV1SpecTemplateSpecInitContainerVolumeDeviceList {
	var returns StatefulSetV1SpecTemplateSpecInitContainerVolumeDeviceList
	_jsii_.Get(
		j,
		"volumeDevice",
		&returns,
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerOutputReference) VolumeDeviceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"volumeDeviceInput",
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerOutputReference)SetRestartPolicy(val *string) {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerOutputReference) PutVolumeDevice(value interface{}) {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerOutputReference) ResetRestartPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetRestartPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerOutputReference) ResetVolumeDevice() {
	_jsii_.InvokeVoid(
		s,
		"resetVolumeDevice",
		nil, // no parameters
