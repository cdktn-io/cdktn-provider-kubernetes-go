...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecContainerLifecyclePreStopTcpSocketList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStatefulSetV1SpecTemplateSpecContainerLifecyclePreStopTcpSocketList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StatefulSetV1SpecTemplateSpecContainerLifecyclePreStopTcpSocketList {
	_init_.Initialize()
...
func NewStatefulSetV1SpecTemplateSpecContainerLifecyclePreStopTcpSocketList_Override(s StatefulSetV1SpecTemplateSpecContainerLifecyclePreStopTcpSocketList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecContainerLifecyclePreStopTcpSocketList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecContainerLifecyclePreStopTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecContainerLifecyclePreStopTcpSocketList) Resolve(context cdktn.IResolveContext) interface{} {
