...
func (s *jsiiProxy_StatefulSetV1SpecTemplateMetadataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateMetadataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
