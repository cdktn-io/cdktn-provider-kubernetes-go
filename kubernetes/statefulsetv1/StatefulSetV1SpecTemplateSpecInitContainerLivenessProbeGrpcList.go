...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerLivenessProbeGrpcList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerLivenessProbeGrpcList) Resolve(context cdktf.IResolveContext) interface{} {
