...
type StatefulSetV1SpecTemplateSpecOutputReference interface {
	...
	Os() StatefulSetV1SpecTemplateSpecOsOutputReference
	OsInput() *StatefulSetV1SpecTemplateSpecOs
	...
	PutOs(value *StatefulSetV1SpecTemplateSpecOs)
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecOutputReference) Os() StatefulSetV1SpecTemplateSpecOsOutputReference {
	var returns StatefulSetV1SpecTemplateSpecOsOutputReference
	_jsii_.Get(
		j,
		"os",
		&returns,
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecOutputReference) OsInput() *StatefulSetV1SpecTemplateSpecOs {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecOutputReference) PutOs(value *StatefulSetV1SpecTemplateSpecOs) {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecOutputReference) ResetOs() {
	_jsii_.InvokeVoid(
		s,
		"resetOs",
		nil, // no parameters
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
