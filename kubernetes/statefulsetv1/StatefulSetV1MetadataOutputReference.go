...
func (s *jsiiProxy_StatefulSetV1MetadataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulSetV1MetadataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
