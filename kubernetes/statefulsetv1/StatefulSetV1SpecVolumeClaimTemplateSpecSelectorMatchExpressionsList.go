...
func (j *jsiiProxy_StatefulSetV1SpecVolumeClaimTemplateSpecSelectorMatchExpressionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStatefulSetV1SpecVolumeClaimTemplateSpecSelectorMatchExpressionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StatefulSetV1SpecVolumeClaimTemplateSpecSelectorMatchExpressionsList {
	_init_.Initialize()
...
func NewStatefulSetV1SpecVolumeClaimTemplateSpecSelectorMatchExpressionsList_Override(s StatefulSetV1SpecVolumeClaimTemplateSpecSelectorMatchExpressionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StatefulSetV1SpecVolumeClaimTemplateSpecSelectorMatchExpressionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StatefulSetV1SpecVolumeClaimTemplateSpecSelectorMatchExpressionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StatefulSetV1SpecVolumeClaimTemplateSpecSelectorMatchExpressionsList) Resolve(context cdktn.IResolveContext) interface{} {
