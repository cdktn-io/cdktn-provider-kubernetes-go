...
func (d *jsiiProxy_DataKubernetesPersistentVolumeClaimSpecSelectorOutputReference) validatePutMatchExpressionsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DataKubernetesPersistentVolumeClaimSpecSelectorMatchExpressions; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DataKubernetesPersistentVolumeClaimSpecSelectorOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataKubernetesPersistentVolumeClaimSpecSelectorOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *DataKubernetesPersistentVolumeClaimSpecSelector; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_DataKubernetesPersistentVolumeClaimSpecSelectorOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataKubernetesPersistentVolumeClaimSpecSelectorOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
