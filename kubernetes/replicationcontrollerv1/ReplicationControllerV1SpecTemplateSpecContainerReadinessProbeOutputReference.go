...
type ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	Grpc() ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeGrpcList
	GrpcInput() interface{}
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference) Grpc() ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeGrpcList {
	var returns ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeGrpcList
	_jsii_.Get(
		j,
		"grpc",
		&returns,
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference) GrpcInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"grpcInput",
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference {
	_init_.Initialize()
...
func NewReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference_Override(r ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference) PutGrpc(value interface{}) {
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference) ResetGrpc() {
	_jsii_.InvokeVoid(
		r,
		"resetGrpc",
		nil, // no parameters
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerReadinessProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
