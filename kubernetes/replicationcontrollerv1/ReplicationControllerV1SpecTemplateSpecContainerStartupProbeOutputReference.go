...
type ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	Grpc() ReplicationControllerV1SpecTemplateSpecContainerStartupProbeGrpcList
	GrpcInput() interface{}
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference) Grpc() ReplicationControllerV1SpecTemplateSpecContainerStartupProbeGrpcList {
	var returns ReplicationControllerV1SpecTemplateSpecContainerStartupProbeGrpcList
	_jsii_.Get(
		j,
		"grpc",
		&returns,
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference) GrpcInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"grpcInput",
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference {
	_init_.Initialize()
...
func NewReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference_Override(r ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference) PutGrpc(value interface{}) {
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference) ResetGrpc() {
	_jsii_.InvokeVoid(
		r,
		"resetGrpc",
		nil, // no parameters
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerStartupProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
