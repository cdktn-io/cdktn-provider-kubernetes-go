...
func (n *jsiiProxy_NetworkPolicySpecIngressFromOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkPolicySpecIngressFromOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
