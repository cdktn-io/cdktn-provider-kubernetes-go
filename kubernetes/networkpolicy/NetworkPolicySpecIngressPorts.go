...
type NetworkPolicySpecIngressPorts struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/network_policy#end_port NetworkPolicy#end_port}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/network_policy#port NetworkPolicy#port}
	Port *string `field:"optional" json:"port" yaml:"port"`
	// protocol represents the protocol (TCP, UDP, or SCTP) which traffic must match.
	//
	// If not specified, this field defaults to TCP.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/network_policy#protocol NetworkPolicy#protocol}
