...
func (n *jsiiProxy_NetworkPolicySpecIngressFromPodSelectorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkPolicySpecIngressFromPodSelectorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
