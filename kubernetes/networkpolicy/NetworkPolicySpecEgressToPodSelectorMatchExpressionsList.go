...
func (j *jsiiProxy_NetworkPolicySpecEgressToPodSelectorMatchExpressionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkPolicySpecEgressToPodSelectorMatchExpressionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkPolicySpecEgressToPodSelectorMatchExpressionsList {
	_init_.Initialize()
...
func NewNetworkPolicySpecEgressToPodSelectorMatchExpressionsList_Override(n NetworkPolicySpecEgressToPodSelectorMatchExpressionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkPolicySpecEgressToPodSelectorMatchExpressionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkPolicySpecEgressToPodSelectorMatchExpressionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkPolicySpecEgressToPodSelectorMatchExpressionsList) Resolve(context cdktn.IResolveContext) interface{} {
