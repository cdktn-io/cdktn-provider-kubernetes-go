...
type DeploymentV1SpecTemplateSpecSecurityContextOutputReference interface {
	...
	WindowsOptions() DeploymentV1SpecTemplateSpecSecurityContextWindowsOptionsOutputReference
	WindowsOptionsInput() *DeploymentV1SpecTemplateSpecSecurityContextWindowsOptions
	// Experimental.
	ComputeFqn() *string
	// Experimental.
	...
	PutWindowsOptions(value *DeploymentV1SpecTemplateSpecSecurityContextWindowsOptions)
	ResetFsGroup()
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference) WindowsOptions() DeploymentV1SpecTemplateSpecSecurityContextWindowsOptionsOutputReference {
	var returns DeploymentV1SpecTemplateSpecSecurityContextWindowsOptionsOutputReference
	_jsii_.Get(
		j,
		"windowsOptions",
		&returns,
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference) WindowsOptionsInput() *DeploymentV1SpecTemplateSpecSecurityContextWindowsOptions {
...
func NewDeploymentV1SpecTemplateSpecSecurityContextOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DeploymentV1SpecTemplateSpecSecurityContextOutputReference {
	_init_.Initialize()
...
func NewDeploymentV1SpecTemplateSpecSecurityContextOutputReference_Override(d DeploymentV1SpecTemplateSpecSecurityContextOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference) PutWindowsOptions(value *DeploymentV1SpecTemplateSpecSecurityContextWindowsOptions) {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference) ResetWindowsOptions() {
	_jsii_.InvokeVoid(
		d,
		"resetWindowsOptions",
		nil, // no parameters
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecSecurityContextOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
