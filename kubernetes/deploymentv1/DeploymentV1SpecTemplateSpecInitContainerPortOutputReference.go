...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecInitContainerPortOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecInitContainerPortOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
