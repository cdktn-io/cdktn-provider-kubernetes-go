...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecContainerLifecyclePreStopList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDeploymentV1SpecTemplateSpecContainerLifecyclePreStopList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DeploymentV1SpecTemplateSpecContainerLifecyclePreStopList {
	_init_.Initialize()
...
func NewDeploymentV1SpecTemplateSpecContainerLifecyclePreStopList_Override(d DeploymentV1SpecTemplateSpecContainerLifecyclePreStopList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecContainerLifecyclePreStopList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecContainerLifecyclePreStopList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecContainerLifecyclePreStopList) Resolve(context cdktn.IResolveContext) interface{} {
