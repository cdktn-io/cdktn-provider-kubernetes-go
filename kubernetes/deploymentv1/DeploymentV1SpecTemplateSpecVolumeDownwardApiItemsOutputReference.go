...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecVolumeDownwardApiItemsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecVolumeDownwardApiItemsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
