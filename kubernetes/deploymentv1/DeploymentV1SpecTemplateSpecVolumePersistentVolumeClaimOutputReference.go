...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) ReadOnly() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"readOnly",
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) ReadOnlyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"readOnlyInput",
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference {
	_init_.Initialize()
...
func NewDeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference_Override(d DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference)SetReadOnly(val interface{}) {
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
