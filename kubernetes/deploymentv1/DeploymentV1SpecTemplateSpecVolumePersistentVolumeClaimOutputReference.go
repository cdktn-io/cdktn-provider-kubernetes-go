...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaimOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
