...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecInitContainerStartupProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecInitContainerStartupProbeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
