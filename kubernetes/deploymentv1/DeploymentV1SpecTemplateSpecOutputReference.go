...
type DeploymentV1SpecTemplateSpecOutputReference interface {
	...
	Os() DeploymentV1SpecTemplateSpecOsOutputReference
	OsInput() *DeploymentV1SpecTemplateSpecOs
	...
	PutOs(value *DeploymentV1SpecTemplateSpecOs)
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecOutputReference) Os() DeploymentV1SpecTemplateSpecOsOutputReference {
	var returns DeploymentV1SpecTemplateSpecOsOutputReference
	_jsii_.Get(
		j,
		"os",
		&returns,
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecOutputReference) OsInput() *DeploymentV1SpecTemplateSpecOs {
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecOutputReference) SchedulerName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schedulerName",
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecOutputReference) SchedulerNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schedulerNameInput",
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecOutputReference)SetSchedulerName(val *string) {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecOutputReference) PutOs(value *DeploymentV1SpecTemplateSpecOs) {
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecOutputReference) ResetOs() {
	_jsii_.InvokeVoid(
		d,
		"resetOs",
		nil, // no parameters
...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecOutputReference) ResetSchedulerName() {
	_jsii_.InvokeVoid(
		d,
		"resetSchedulerName",
		nil, // no parameters
