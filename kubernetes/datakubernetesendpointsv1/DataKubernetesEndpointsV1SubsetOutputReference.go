...
func (d *jsiiProxy_DataKubernetesEndpointsV1SubsetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataKubernetesEndpointsV1SubsetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
