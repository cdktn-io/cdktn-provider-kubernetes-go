...
func (j *jsiiProxy_DataKubernetesServiceAccountImagePullSecretList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataKubernetesServiceAccountImagePullSecretList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesServiceAccountImagePullSecretList {
	_init_.Initialize()
...
func NewDataKubernetesServiceAccountImagePullSecretList_Override(d DataKubernetesServiceAccountImagePullSecretList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesServiceAccountImagePullSecretList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesServiceAccountImagePullSecretList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesServiceAccountImagePullSecretList) Resolve(context cdktn.IResolveContext) interface{} {
