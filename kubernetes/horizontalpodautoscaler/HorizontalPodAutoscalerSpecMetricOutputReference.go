...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecMetricOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHorizontalPodAutoscalerSpecMetricOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) HorizontalPodAutoscalerSpecMetricOutputReference {
	_init_.Initialize()
...
func NewHorizontalPodAutoscalerSpecMetricOutputReference_Override(h HorizontalPodAutoscalerSpecMetricOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecMetricOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
