...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsMetricSelectorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHorizontalPodAutoscalerSpecMetricPodsMetricSelectorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HorizontalPodAutoscalerSpecMetricPodsMetricSelectorList {
	_init_.Initialize()
...
func NewHorizontalPodAutoscalerSpecMetricPodsMetricSelectorList_Override(h HorizontalPodAutoscalerSpecMetricPodsMetricSelectorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsMetricSelectorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsMetricSelectorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsMetricSelectorList) Resolve(context cdktn.IResolveContext) interface{} {
