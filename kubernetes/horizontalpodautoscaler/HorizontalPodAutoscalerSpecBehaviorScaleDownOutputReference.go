...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference {
	_init_.Initialize()
...
func NewHorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference_Override(h HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
