...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsTargetOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHorizontalPodAutoscalerSpecMetricPodsTargetOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HorizontalPodAutoscalerSpecMetricPodsTargetOutputReference {
	_init_.Initialize()
...
func NewHorizontalPodAutoscalerSpecMetricPodsTargetOutputReference_Override(h HorizontalPodAutoscalerSpecMetricPodsTargetOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsTargetOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsTargetOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsTargetOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsTargetOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
