...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHorizontalPodAutoscalerSpecMetricPodsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HorizontalPodAutoscalerSpecMetricPodsOutputReference {
	_init_.Initialize()
...
func NewHorizontalPodAutoscalerSpecMetricPodsOutputReference_Override(h HorizontalPodAutoscalerSpecMetricPodsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricPodsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
