...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference {
	_init_.Initialize()
...
func NewHorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference_Override(h HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
