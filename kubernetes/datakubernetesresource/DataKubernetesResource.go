...
func (j *jsiiProxy_DataKubernetesResource) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataKubernetesResource) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataKubernetesResource) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataKubernetesResource) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataKubernetesResource) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func DataKubernetesResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataKubernetesResource) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataKubernetesResource) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
