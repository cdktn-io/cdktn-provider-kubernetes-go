# CDKTN Go bindings for hashicorp/kubernetes provider version 3.2.1

This repo builds and publishes the [Terraform kubernetes provider](https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs) bindings for [CDK Terrain](https://cdktn.io).
...
Find auto-generated docs for this provider [here](https://github.com/cdktn-io/cdktn-provider-kubernetes/blob/main/docs/API.go.md).
...
* [Terraform kubernetes provider](https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1)
